...
build:
	make -f $(MAKEFILE_DIR)/ZSAppTrcMthClient_sub.mk

clean:
	make -f $(MAKEFILE_DIR)/ZSAppTrcMthClient_sub.mk clean

help:
	@echo "Make file to be used with GNU make."
	@echo.
	@echo "Aufruf   : make -f ZSAppTrcMthClient.mk [CONFIG=<Debug|Release>] [Target]"
	@echo.
	@echo "Targets  : build   - (default) Creates the target."
	@echo "           clean   - Deletes all output files."
	@echo "           help    - Shows this help text."
	@echo.
	@echo "Example  : make -f ZSAppTrcMthClient.mk CONFIG=Debug build
	@echo.
