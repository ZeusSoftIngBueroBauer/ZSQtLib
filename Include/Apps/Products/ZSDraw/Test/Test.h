...
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_90 0
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_180 0
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_270 0
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_30 0
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_120 0
...
#define TEST_ADD_OBJECTS_STANDARDSHAPES_LINES_CHECKMARK 0
...
#define TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_RECTANGLES 0
...
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_0 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_90 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_180 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_270 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_30 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_120 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_210 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALRECT_ANGLE_300 1
#define TEST_PIXELS_DRAWINGS_800x600_OJBECT_COORDINATES_PHYSVALPOLYGON 1
#define TEST_PIXELS_DRAWINGS_800x600_ADD_OBJECTS 1
#define TEST_PIXELS_DRAWINGS_800x600_DRAW_OBJECTS 1
#define TEST_METRICS_DRAWINGS 1
#define TEST_METRICS_DRAWINGS_YSCALE_TOPDOWN 1
...
#define TEST_DRAW_OBJECTS_STANDARDSHAPES_LINES_SMALLPLUSSIGN 1
#define TEST_DRAW_OBJECTS_STANDARDSHAPES_LINES_BIGPLUSSIGN 1
#define TEST_DRAW_OBJECTS_STANDARDSHAPES_LINES_CHECKMARK 1
#define TEST_DRAW_OBJECTS_STANDARDSHAPES_LINES_SMALLRECT 1
...
public: // type definition and constants
    ...
    const QString c_strGraphObjNameStar1 = "Star-1";
    ...
    const QString c_strGraphObjNameConnectionLineLine1Pt2Line2Pt2 = "CnctLine-Line-1-P2-Line-2-P2";
    const QString c_strGraphObjNameConnectionLineLine2Pt1Line4Pt2 = "CnctLine-Line-2-P1-Line-4-P2";
    const QString c_strGraphObjNameConnectionLineLine4Pt1Line3Pt1 = "CnctLine-Line-4-P1-Line-3-P1";
    const QString c_strGraphObjNameConnectionLineLine3Pt2Line1Pt1 = "CnctLine-Line-3-P2-Line-1-P1";
...
protected: // instance methods
    ...
    void createTestGroupAddStandardShapesGroupEllipsesCrosses(ZS::Test::CTestStepGroup* i_pTestStepGroupParent);
    void createTestGroupAddStandardShapesGroupEllipsesCrossesModifications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent);
    void createTestGroupAddStandardShapesGroupTextsCrosses(ZS::Test::CTestStepGroup* i_pTestStepGroupParent);
...
protected: // instance members
    ...
    QString m_strTextSmallCross1HorizontalBar;
    QString m_strTextSmallCross2VerticalBar;
    QString m_strTextSmallCross2HorizontalBar;
    ...
    // Stars
    QPointF m_ptPosStar1;
    ZS::Draw::CPhysValPolygon* m_pPhysValPolygonStar1 = nullptr;
    QPolygonF m_polygonStar1;
    ZS::PhysVal::CPhysVal m_physValAngleStar1;
    QPointF m_ptPosStar2;
    ZS::Draw::CPhysValPolygon* m_pPhysValPolygonStar2 = nullptr;
    QPolygonF m_polygonStar2;
    ZS::PhysVal::CPhysVal m_physValAngleStar2;
    QPointF m_ptPosStar3;
    ZS::Draw::CPhysValPolygon* m_pPhysValPolygonStar3 = nullptr;
    QPolygonF m_polygonStar3;
    ZS::PhysVal::CPhysVal m_physValAngleStar3;
    QPointF m_ptPosStar4;
    ZS::Draw::CPhysValPolygon* m_pPhysValPolygonStar4 = nullptr;
    ...
    QPolygonF m_polygonConnectionLineLine1P2Line2P2;
    ZS::Draw::CPhysValPolygon* m_pPhysValPolygonConnectionLineLine1P2Line2P2 = nullptr;
    QPolygonF m_polygonConnectionLineLine2P1Line4P2;
    ZS::Draw::CPhysValPolygon* m_pPhysValPolygonConnectionLineLine2P1Line4P2 = nullptr;
    QPolygonF m_polygonConnectionLineLine4P1Line3P1;
