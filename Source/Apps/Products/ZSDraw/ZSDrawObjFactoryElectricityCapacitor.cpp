...
/*******************************************************************************
class CObjFactoryCapacitor : public CObjFactory
*******************************************************************************/
...
//------------------------------------------------------------------------------
CObjFactoryCapacitor::CObjFactoryCapacitor(
...
//------------------------------------------------------------------------------
    CObjFactory(
        ...
        /* strGraphObjClassName */ "CGraphObjCapacitor",
...
//------------------------------------------------------------------------------
SErrResultInfo CObjFactoryCapacitor::saveGraphObj(
...
//------------------------------------------------------------------------------
{
    ...
    CGraphObjCapacitor* pGraphObj = dynamic_cast<CGraphObjCapacitor*>(i_pGraphObj);
    ...
    i_xmlStreamWriter.writeTextElement( "Capacitance", QString::number(pGraphObj->getCapacitance()) );
...
//------------------------------------------------------------------------------
CGraphObj* CObjFactoryCapacitor::loadGraphObj(
    CDrawingScene*    i_pDrawingScene,
    ...
    if( i_pDrawingScene->findGraphObj(i_strObjId) == nullptr )
    {
        ...
        while( !i_xmlStreamReader.hasError() && !i_xmlStreamReader.atEnd() )
        {
            ...
            if( i_xmlStreamReader.isStartElement() )
            {
                ...
                else if( strElemName == "Capacitance" )
                {
        ...
        {
            pGraphObj = new CGraphObjCapacitor(
                /* pDrawingScene */ i_pDrawingScene,
            ...
            pGraphObj->setCapacitance(fCapacitance_F);
...
//------------------------------------------------------------------------------
void CObjFactoryCapacitor::ResetCtorsDtorsCounters()
//------------------------------------------------------------------------------
{
    CGraphObjCapacitor::ResetCtorsDtorsCounters();
}
