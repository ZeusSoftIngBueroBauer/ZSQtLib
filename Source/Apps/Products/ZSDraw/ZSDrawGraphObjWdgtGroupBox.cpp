...
//------------------------------------------------------------------------------
void CGraphObjWdgtGroupBox::ResetCtorsDtorsCounters()
//------------------------------------------------------------------------------
{
...
qint64 CGraphObjWdgtGroupBox::s_iCtorsCount = 1;
qint64 CGraphObjWdgtGroupBox::s_iDtorsCount = 1;

CTrcAdminObj* CGraphObjWdgtGroupBox::s_pTrcAdminObjCtorsAndDtor = nullptr;
...
//------------------------------------------------------------------------------
    CGraphObjWdgt(
        ...
        /* strClassName  */ "CGraphObjWdgtGroupBox",
        /* strType       */ "GroupBox",
        /* strObjName    */ i_strObjName.isEmpty() ? "GroupBox" + QString::number(s_iCtorsCount) : i_strObjName,
        /* strObjId      */ i_strObjId.isEmpty() ? "GroupBox" + QString::number(s_iCtorsCount) : i_strObjId,
    ...
    m_pGroupBox(nullptr)
{
    ...
    {
        s_pTrcAdminObjCtorsAndDtor = CTrcServer::GetTraceAdminObj("ZS::Draw::QtWidgets", "CGraphObjWdgtGroupBox::CtorsAndDtor", "");
    }
