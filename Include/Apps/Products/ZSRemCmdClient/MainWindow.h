...
#ifndef ZSApps_RemCmdClient_MainWindow_h
#define ZSApps_RemCmdClient_MainWindow_h
...
protected slots:
    void onActSettingsRemCmdClientTriggered();
protected slots:
...
protected slots:
    void onRemCmdClientStateChanged( QObject* i_pRemCmdClient, int i_iState );
    void onRemCmdClientDestroyed( QObject* i_pRemCmdClient );
...
protected: // instance members
    ...
    QAction*                     m_pActSettingsRemCmdClient;
    QMenu*                       m_pMnuDebug;
    ...
    QLabel*                      m_pLblErrors;
    QWidget*                     m_pWdgtRemCmdClientCnctStatus;
    QLabel*                      m_pLblRemCmdClientCnctStatusIcon;
    CWidgetCentral*              m_pWdgtCentral;
    ZS::Ipc::GUI::CDlgIpcClient* m_pDlgRemCmdClient;
...
#endif // #ifndef ZSApps_RemCmdClient_MainWindow_h
