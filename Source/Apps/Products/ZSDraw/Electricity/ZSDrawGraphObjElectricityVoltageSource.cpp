...
#include "Electricity/ZSDrawWdgtFormatGraphObjsElectricityVoltageSource.h"
    ...
    m_fVoltage_V(1.0)
{
    ...
    */
    ...
    m_pDrawingScene->onGraphObjCreationFinished(m_pLinSignMinus);
    ...
    m_pDrawingScene->onGraphObjCreationFinished(m_pLinSignPlusHor);
    ...
    m_pDrawingScene->onGraphObjCreationFinished(m_pLinSignPlusVer);
...
//------------------------------------------------------------------------------
void CGraphObjVoltageSource::openFormatGraphObjsDialog()
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
void CGraphObjVoltageSource::onDrawSettingsChanged(const CDrawSettings& i_drawSettingsOld)
//------------------------------------------------------------------------------
{
    ...
    drawSettingsBody.setFillStyle(m_drawSettings.fillStyle());
