...
#ifndef ZSPhysValGUI_DllMain_h
#define ZSPhysValGUI_DllMain_h
...
#ifdef ZSPHYSVALGUIDLL_EXPORTS
    #define ZSPHYSVALGUIDLL_API __API_EXPORT
#else
    #define ZSPHYSVALGUIDLL_API __API_IMPORT
#endif
...
#endif // #ifndef ZSPhysValGUI_DllMain_h
