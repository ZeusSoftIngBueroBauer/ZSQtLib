...
#ifndef ZSDraw_DrawGraphObjTextGeometryPropertiesWdgt_h
#define ZSDraw_DrawGraphObjTextGeometryPropertiesWdgt_h
...
namespace Draw
{
class CModelGraphObjTextGeometry;

//******************************************************************************
class ZSDRAWDLL_API CWdgtGraphObjTextGeometryProperties : public CWdgtGraphObjPropertiesAbstract
//******************************************************************************
{
    Q_OBJECT
public: // class methods
    ...
    static QString ClassName() { return "CWdgtGraphObjTextGeometryProperties"; }
public: // ctors and dtor
    CWdgtGraphObjTextGeometryProperties(
        CDrawingScene* i_pDrawingScene,
        const QString& i_strNameSpace,
        const QString& i_strObjName,
        QWidget* i_pWdgtParent = nullptr);
    virtual ~CWdgtGraphObjTextGeometryProperties();
...
private: // instance members
    ...
    CModelGraphObjTextGeometry* m_pModelGeometry;
...
#endif // #ifndef ZSDraw_DrawGraphObjTextGeometryPropertiesWdgt_h
