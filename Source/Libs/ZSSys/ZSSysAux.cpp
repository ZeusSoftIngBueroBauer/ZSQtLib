...
//------------------------------------------------------------------------------
{
    /*  0 */ { QMetaType::UnknownType, "UnknownType" },
    /*  1 */ { QMetaType::Bool, "Bool" },
    /*  2 */ { QMetaType::Int, "Int" },
    /*  3 */ { QMetaType::UInt, "UInt" },
    /*  4 */ { QMetaType::LongLong, "LongLong" },
    /*  5 */ { QMetaType::ULongLong, "ULongLong" },
    /*  6 */ { QMetaType::Double, "Double" },
    /*  7 */ { QMetaType::QChar, "Char" },
    /*  8 */ { QMetaType::QVariantMap, "VariantMap" },
    /*  9 */ { QMetaType::QVariantList, "VariantList" },
    /* 10 */ { QMetaType::QString, "String" },
    /* 11 */ { QMetaType::QStringList, "StringList" },
    /* 12 */ { QMetaType::QByteArray, "ByteArray" },
    /* 13 */ { QMetaType::QBitArray, "BitArray" },
    /* 14 */ { QMetaType::QDate, "Date" },
    /* 15 */ { QMetaType::QTime, "Time" },
    /* 16 */ { QMetaType::QDateTime, "DateTime" },
    /* 17 */ { QMetaType::QUrl, "Url" },
    /* 18 */ { QMetaType::QLocale, "Locale" },
    /* 19 */ { QMetaType::QRect, "Rect" },
    /* 20 */ { QMetaType::QRectF, "RectF" },
    /* 21 */ { QMetaType::QSize, "Size" },
    /* 22 */ { QMetaType::QSizeF, "SizeF" },
    /* 23 */ { QMetaType::QLine, "Line" },
    /* 24 */ { QMetaType::QLineF, "LineF" },
    /* 25 */ { QMetaType::QPoint, "Point" },
    /* 26 */ { QMetaType::QPointF, "PointF" },
    /* 28 */ { QMetaType::QVariantHash, "VariantHash" },
    /* 29 */ { QMetaType::QEasingCurve, "EasingCurve" },
    /* 30 */ { QMetaType::QUuid, "Uuid" },
    /* 31 */ { QMetaType::VoidStar, "VoidStar" },
    /* 32 */ { QMetaType::Long, "Long" },
    /* 33 */ { QMetaType::Short, "Short" },
    /* 34 */ { QMetaType::Char, "Char" },
    /* 35 */ { QMetaType::ULong, "ULong" },
    /* 36 */ { QMetaType::UShort, "UShort" },
    /* 37 */ { QMetaType::UChar, "UChar" },
    /* 38 */ { QMetaType::Float, "Float" },
    /* 39 */ { QMetaType::QObjectStar, "ObjectStar" },
    /* 40 */ { QMetaType::SChar, "SChar" },
    /* 41 */ { QMetaType::QVariant, "Variant" },
    /* 42 */ { QMetaType::QModelIndex, "ModelIndex" },
    /* 43 */ { QMetaType::Void, "Void" },
    /* 44 */ { QMetaType::QRegularExpression, "RegExp" },
    /* 45 */ { QMetaType::QJsonValue, "JsonValue" },
    /* 46 */ { QMetaType::QJsonObject, "JsonObject" },
    /* 47 */ { QMetaType::QJsonArray, "JsonArray" },
    /* 48 */ { QMetaType::QJsonDocument, "JsonDocument" },
    /* 49 */ { QMetaType::QByteArrayList, "ByteArrayList" },
    /* 50 */ { QMetaType::QPersistentModelIndex, "PersistentModelIndex" },
    /* 51 */ { QMetaType::Nullptr, "Nullptr" },
    /* 52 */ { QMetaType::QCborSimpleType, "CborSimpleType" },
    /* 53 */ { QMetaType::QCborValue, "QCborValue" },
    /* 54 */ { QMetaType::QCborArray, "QCborArray" },
    /* 55 */ { QMetaType::QCborMap, "QCborMap" },
    /* 56 */ { QMetaType::Char16, "Char16" },
    /* 57 */ { QMetaType::Char32, "Char32" },
    /* 58 */ { QMetaType::QVariantPair, "VariantPair" },
    /* 59 */ { 59/*QMetaType::Int128*/, "Int128" },
    /* 60 */ { 60/*QMetaType::UInt128*/, "UInt128" },
    /* 61 */ { 61/*QMetaType::Float128*/, "Float128" },
    /* 62 */ { 62/*QMetaType::BFloat16*/, "BFloat16" },
    /* 63 */ { QMetaType::Float16, "Float16" },
    /*  0x1000  4096 */ { QMetaType::QFont, "Font" },
    /*  0x1001  4097 */ { QMetaType::QPixmap, "Pixmap" },
    /*  0x1002  4098 */ { QMetaType::QBrush, "Brush" },
    /*  0x1003  4099 */ { QMetaType::QColor, "Color" },
    /*  0x1004  4100 */ { QMetaType::QPalette, "Palette" },
    /*  0x1005  4101 */ { QMetaType::QIcon, "Icon" },
    /*  0x1006  4102 */ { QMetaType::QImage, "Image" },
    /*  0x1007  4103 */ { QMetaType::QPolygon, "Polygon" },
    /*  0x1008  4104 */ { QMetaType::QRegion, "Region" },
    /*  0x1009  4105 */ { QMetaType::QBitmap, "Bitmap" },
    /*  0x100a  4106 */ { QMetaType::QCursor, "Cursor" },
    /*  0x100b  4107 */ { QMetaType::QKeySequence, "KeySequence" },
    /*  0x100c  4108 */ { QMetaType::QPen, "Pen" },
    /*  0x100d  4109 */ { QMetaType::QTextLength, "TextLength" },
    /*  0x100e  4110 */ { QMetaType::QTextFormat, "TextFormat" },
    /*  0x1010  4112 */ { QMetaType::QTransform, "Transform" },
    /*  0x1011  4113 */ { QMetaType::QMatrix4x4, "Matrix4x4" },
    /*  0x1012  4114 */ { QMetaType::QVector2D, "Vector2D" },
    /*  0x1013  4115 */ { QMetaType::QVector3D, "Vector3D" },
    /*  0x1014  4116 */ { QMetaType::QVector4D, "Vector4D" },
    /*  0x1015  4117 */ { QMetaType::QQuaternion, "Quaternion" },
    /*  0x1016  4118 */ { QMetaType::QPolygonF, "PolygonF" },
    /*  0x1017  4119 */ { QMetaType::QColorSpace, "ColorSpace" },
    /*  0x2000  8192 */ { QMetaType::QSizePolicy, "SizePolicy" },
    /* 0x10000 65536 */ { QMetaType::User, "User" }
};
#endif
