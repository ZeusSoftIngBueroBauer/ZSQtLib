...
//------------------------------------------------------------------------------
int CObjFactoryConnectionPoint::getNumberOfCreatedGraphObjects() const
//------------------------------------------------------------------------------
{
    return CGraphObjConnectionPoint::s_iInstCount;
}
...
//------------------------------------------------------------------------------
{
    ...
    if( bPosValid )
    {
        ...
        if( i_pGraphObjGroupParent != nullptr )
        {
            ...
            //i_pGraphObjGroupParent->addGraphObj(pGraphObj);
        }
