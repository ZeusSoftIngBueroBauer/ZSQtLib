...
#ifndef ZSRemCmd_DllMain_h
#define ZSRemCmd_DllMain_h
...
#ifdef ZSREMCMDDLL_EXPORTS
    #define ZSREMCMDDLL_API __API_EXPORT
#else
    #define ZSREMCMDDLL_API __API_IMPORT
#endif
...
#endif // #ifndef ZSRemCmd_DllMain_h
