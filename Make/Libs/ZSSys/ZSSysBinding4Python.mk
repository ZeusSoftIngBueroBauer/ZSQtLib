...
ifeq ($(PLATFORM), Win32)
    ZSQTLIBS := $(LIB_PREFIX)ZSSys.$(LIB_EXT)
else ifeq ($(PLATFORM), Linux)
    ZSQTLIBS := $(ZSQTLIB_DIR_LIB)/$(LIB_PREFIX)ZSSys.$(LIB_EXT)
endif
export ZSQTLIBS
...
help:
	...
	@echo .
	@echo "Aufruf   : make -f ZSSysBinding4Python.mk [CONFIG=<Debug|Release>] [Target]"
	@echo .
