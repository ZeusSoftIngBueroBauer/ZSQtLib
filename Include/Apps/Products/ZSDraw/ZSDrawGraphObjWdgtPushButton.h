...
public: // class methods
    ...
    static QString ClassName() { return "CGraphObjWdgtPushButton"; } // Please note that the static class functions name must be different from the non static virtual member function "className"
