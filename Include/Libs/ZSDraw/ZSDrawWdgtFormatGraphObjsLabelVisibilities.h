...
protected slots:
    ...
    void onCmbDescriptionLabelAnchorSelPtCurrentIndexChanged( int );
    void onChkDescriptionLabelVisibleStateChanged( int );
    void onChkDescriptionLabelAnchorLineVisibleStateChanged( int );
...
private: // instance members
    ...
    QHBoxLayout*             m_pLytLineDescriptionLabelVisibilities;
    QLabel*                  m_pLblDescriptionLabel;
    QComboBox*               m_pCmbDescriptionLabelAnchorSelPt;
    QCheckBox*               m_pChkDescriptionLabelVisible;
    QLabel*                  m_pLblDescriptionLabelAnchorLineVisible;
    QCheckBox*               m_pChkDescriptionLabelAnchorLineVisible;
