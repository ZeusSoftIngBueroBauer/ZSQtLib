...
//------------------------------------------------------------------------------
{
    ...
    createTestGroupAddStandardShapesLines(
        pGrpAddStandardShapes, io_idxGroup, i_drawingSize, QStringList({c_strGraphObjNamePlusSigns}));
    createTestGroupAddStandardShapesGroups(
        pGrpAddStandardShapes, io_idxGroup, i_drawingSize, QStringList({c_strGraphObjNamePlusSigns}));
    createTestGroupModifyStandardShapes(
        pGrpAddStandardShapes, io_idxGroup, i_drawingSize, QStringList({c_strGraphObjNamePlusSigns}));
...
//------------------------------------------------------------------------------
{
    ...
    if (i_strlstGraphObjGroupNames.isEmpty() || i_strlstGraphObjGroupNames.contains(c_strGraphObjNamePlusSigns)) {
