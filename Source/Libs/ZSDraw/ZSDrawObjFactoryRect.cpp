...
//------------------------------------------------------------------------------
    CObjFactory(
        ...
        /* strGraphObjNameSpace */ CGraphObjRect::NameSpace(),
        /* strGraphObjClassName */ CGraphObjRect::ClassName(),
...
//------------------------------------------------------------------------------
void CObjFactoryRect::ResetCtorsDtorsCounters()
//------------------------------------------------------------------------------
{
    CGraphObjRect::ResetCtorsDtorsCounters();
}
