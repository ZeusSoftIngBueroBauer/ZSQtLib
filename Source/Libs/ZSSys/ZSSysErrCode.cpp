...
const SEnumEntry s_arEnumStrErrResult[EResultCount] =
{
    ...
    /* 126 */ SEnumEntry( EResultValuesNotEqual, "ValuesNotEqual", "Compared Values Not Equal" ),
    /* 127 */ SEnumEntry( EResultNotConvertible, "NotConvertible", "Unit Not Convertible Into Destination Unit" ),
    /* 128 */ SEnumEntry( EResultInvalidSIUnit, "InvalidSIUnit", "Invalid SI Unit" ),
    /* 129 */ SEnumEntry( EResultPhysSizeNotChangeable, "PhysicalSizeNotChangeable", "Physical Size Of Physical Values Are Not Changeable" ),
    /* 130 */ SEnumEntry( EResultRefValMissing, "RefValMissing", "Reference Value(s) Missing" ),
    /* 131 */ SEnumEntry( EResultInvalidRefValUnit, "InvalidRefValUnit", "Invalid Unit Of Reference Value" ),
    /* 132 */ SEnumEntry( EResultLogarithmicUnitExpected, "LogarithmicUnitExpected", "Expected A Logarithmic Unit" ),
    /* 133 */ SEnumEntry( EResultDimensionOutOfRange, "DimensionOutOfRange", "Dimension Out Of Range" ),
    /* 134 */ SEnumEntry( EResultValIdxOutOfRange, "ValIdxOutOfRange", "Value Index Out Of Range" ),
    /* 135 */ SEnumEntry( EResultValueOutOfRange, "ValueOutOfRange", "Value Out Of Range" ),
    /* 136 */ SEnumEntry( EResultValueExceedsMinLimit, "ValueExceedsMinLimit", "Value Is Below Minimal Limit" ),
    /* 137 */ SEnumEntry( EResultValueExceedsMaxLimit, "ValueExceedsMaxLimit", "Value Is Above Maximum Limite" ),
    /* 138 */ SEnumEntry( EResultNoValueAssigned, "NoValueAssigned", "No Value Assigned" ),
    /* 139 */ SEnumEntry( EResultNullValueNotAllowed, "NullValueNotAllowed", "Null Value Not Allowed" ),
    /* 140 */ SEnumEntry( EResultValueCorrected,  "ValueCorrected", "Value Corrected" ),
    /* 141 */ SEnumEntry( EResultInvalidDataType, "InvalidDataType", "Invalid Or Unknown Data Type" ),
    /* 142 */ SEnumEntry( EResultUnknownDataType, "UnknownDataType", "Unknown Data Type" ),
    /* 143 */ SEnumEntry( EResultUnsupportedDataType, "UnsupportedDataType", "Data Type Not Supported" ),
    /* 144 */ SEnumEntry( EResultPrimaryKeyConstraintViolation, "PrimaryKeyConstraintViolation", "Primary Key Constraint Violation" ),
    /* 145 */ SEnumEntry( EResultUniqueConstraintViolation, "UniqueConstraintViolation", "Unique Constraint Violation" ),
    /* 146 */ SEnumEntry( EResultForeignKeyConstraintViolation, "ForeignKeyConstraintViolation", "Foreign Key Constraint Violation" ),
    /* 147 */ SEnumEntry( EResultStatementError, "StatementError", "Statement Error" ),
    /* 148 */ SEnumEntry( EResultTransactionError, "TransactionError", "TransactionError" )
};
