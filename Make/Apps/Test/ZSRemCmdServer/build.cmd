@echo off
set PROJECTNAME=ZSAppRemCmd_8.0
...
:ERROR_ZSQTLIBDIR_NOTDEFINED
@echo !
@echo -----------------------------------------------------------------------
@echo The environment variable ZSQTLIBDIR is not defined.
@echo May be set for example to "Y:\SystemManagement_dev\ZSQtLib"
@echo -----------------------------------------------------------------------
@echo !
@goto EOF
