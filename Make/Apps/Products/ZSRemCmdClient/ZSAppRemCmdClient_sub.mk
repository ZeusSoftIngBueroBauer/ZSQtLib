...
ZSQTLIBS := ZSSys.lib ZSSysGUI.lib \
	ZSIpc.lib ZSIpcGUI.lib \
	ZSTrace.lib ZSTraceGUI.lib \
	ZSRemCmd.lib ZSRemCmdGUI.lib
...
ZSQTLIBS := ZSSysd.lib ZSSysGUId.lib \
	ZSIpcd.lib ZSIpcGUId.lib \
	ZSTraced.lib ZSTraceGUId.lib \
	ZSRemCmdd.lib ZSRemCmdGUId.lib
...
help:
	@echo off
	@echo "Usage: make -f ZSAppRemCmdClient_sub.mk [CONFIG=<Debug|Release>] [target]"
	@echo ""
	@echo "Targets  : build   - (default) Creates the target."
	@echo "           clean   - Deletes all output files."
	@echo "           help    - Shows this help text."
	@echo 
	@echo "Example  : make -f ZSAppRemCmdClient_sub.mk CONFIG=Debug build
	@echo 
...
$(INT_DIR)/%.obj: $(SRC_DIR)/%.cpp $(DEP_DIR)/%.d
	...
	$(CXX) $(INCLUDES) $(DEFINES) /D "TEST_GUI" $(CFLAGS) $<
