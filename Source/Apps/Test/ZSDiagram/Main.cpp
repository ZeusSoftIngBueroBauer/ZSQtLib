...
#pragma message(__FILE__ ": Linking against = " ZSDIAGRAMLIB)
#pragma comment(lib, ZSDIAGRAMLIB)
...
//------------------------------------------------------------------------------
{
    ...
    pAppExample = new CApplication(
        /* argc                  */ argc,
        /* argv                  */ argv,
        /* strOrganizationName   */ "ZeusSoft",
        /* strOrganizationDomain */ "ZeusSoft.de",
        /* strAppName            */ "ZSAppTestDiagram",
        /* strAppNameWindowTitle */ "ZSApp-Test-Diagram (" + ZS::System::c_strSysVersionNr + ")" );
