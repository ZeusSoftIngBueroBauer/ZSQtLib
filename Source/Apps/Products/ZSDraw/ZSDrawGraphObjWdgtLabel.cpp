...
//------------------------------------------------------------------------------
void CGraphObjWdgtLabel::ResetCtorsDtorsCounters()
//------------------------------------------------------------------------------
{
...
qint64 CGraphObjWdgtLabel::s_iCtorsCount = 1;
qint64 CGraphObjWdgtLabel::s_iDtorsCount = 1;

CTrcAdminObj* CGraphObjWdgtLabel::s_pTrcAdminObjCtorsAndDtor = nullptr;
...
//------------------------------------------------------------------------------
    CGraphObjWdgt(
        ...
        /* strClassName  */ "CGraphObjWdgtLabel",
        /* strType       */ "Label",
        /* strObjName    */ i_strObjName.isEmpty() ? "Label" + QString::number(s_iCtorsCount) : i_strObjName,
        /* strObjId      */ i_strObjId.isEmpty() ? "Label" + QString::number(s_iCtorsCount) : i_strObjId,
    ...
    m_pLabel(nullptr)
{
    ...
    {
        s_pTrcAdminObjCtorsAndDtor = CTrcServer::GetTraceAdminObj("ZS::Draw::QtWidgets", "CGraphObjWdgtLabel::CtorsAndDtor", "");
    }
