...
#ifndef ZSSNMPDllMain_h
#define ZSSNMPDllMain_h
...
#ifdef ZSSNMPDLL_EXPORTS
    #define ZSSNMPDLL_API __API_EXPORT
#else
    #define ZSSNMPDLL_API __API_IMPORT
#endif


#endif // #ifndef ZSSNMPDllMain_h
