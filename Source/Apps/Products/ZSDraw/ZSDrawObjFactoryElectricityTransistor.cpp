...
//------------------------------------------------------------------------------
CObjFactoryTransistor::CObjFactoryTransistor(
...
//------------------------------------------------------------------------------
    CObjFactory(
        ...
        /* strGraphObjClassName */ "CGraphObjTransistor",
...
//------------------------------------------------------------------------------
{
    ...
    CGraphObj* pGraphObj = new CGraphObjTransistor(
...
//------------------------------------------------------------------------------
SErrResultInfo CObjFactoryTransistor::saveGraphObj(
...
//------------------------------------------------------------------------------
{
    ...
    CGraphObjTransistor* pGraphObj = dynamic_cast<CGraphObjTransistor*>(i_pGraphObj);
    ...
    i_xmlStreamWriter.writeTextElement( "DopingType", pGraphObj->getDopingTypeAsString() );
...
//------------------------------------------------------------------------------
CGraphObj* CObjFactoryTransistor::loadGraphObj(
    CDrawingScene*    i_pDrawingScene,
...
//------------------------------------------------------------------------------
{
    ...
    if( i_pDrawingScene->findGraphObj(i_strObjId) == nullptr )
    {
        ...
        CGraphObjTransistor::EDopingType dopingType = CGraphObjTransistor::EDopingTypeNPN;
        QPointF                          ptPos;
        QSizeF                           siz;
        ...
        while( !i_xmlStreamReader.hasError() && !i_xmlStreamReader.atEnd() )
        {
            ...
            if( i_xmlStreamReader.isStartElement() )
            {
                ...
                else if( strElemName == "DopingType" )
                {
                    strElemText = i_xmlStreamReader.readElementText();

                    CGraphObjTransistor::EDopingType typeTmp = CGraphObjTransistor::Str2DopingType(strElemText);

                    if( typeTmp != CGraphObjTransistor::EDopingTypeUndefined )
                    {
                        dopingType = typeTmp;
                    }
                }
        ...
        {
            pGraphObj = new CGraphObjTransistor(
                /* pDrawingScene */ i_pDrawingScene,
...
//------------------------------------------------------------------------------
void CObjFactoryTransistor::ResetCtorsDtorsCounters()
//------------------------------------------------------------------------------
{
    CGraphObjTransistor::ResetCtorsDtorsCounters();
}
