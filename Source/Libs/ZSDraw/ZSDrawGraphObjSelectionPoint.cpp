...
//------------------------------------------------------------------------------
    CGraphObj(
        ...
        /* strObjName    */ i_pGraphObjSelected->getObjName() + ".SelPt." + CEnumSelectionPoint(i_selectionPoint).toString(),
        /* strObjId      */ i_pGraphObjSelected->getObjName() + ".SelPt." + CEnumSelectionPoint(i_selectionPoint).toString(),
