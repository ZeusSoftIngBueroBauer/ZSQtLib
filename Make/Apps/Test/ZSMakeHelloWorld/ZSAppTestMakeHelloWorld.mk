...
MODULE := ZSAppTestMakeHelloWorld
export MODULE
...
build:
	make -f $(MAKEFILE_DIR)/ZSAppTestMakeHelloWorld_sub.mk

clean:
	make -f $(MAKEFILE_DIR)/ZSAppTestMakeHelloWorld_sub.mk clean

help:
	@echo "Make file to be used with GNU make."
	@echo.
	@echo "Aufruf   : make -f ZSAppTestMakeHelloWorld.mk [CONFIG=<Debug|Release>] [Target]"
	@echo.
	@echo "Targets  : build   - (default) Creates the target."
	@echo "           clean   - Deletes all output files."
	@echo "           help    - Shows this help text."
	@echo.
	@echo "Example  : make -f ZSAppTestMakeHelloWorld.mk CONFIG=Debug build
	@echo.
