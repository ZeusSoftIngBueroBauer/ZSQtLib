...
#ifndef ZSDraw_GraphObjConnectionPointGeometryModel_h
#define ZSDraw_GraphObjConnectionPointGeometryModel_h
...
//******************************************************************************
class ZSDRAWDLL_API CModelGraphObjConnectionPointGeometry : public QAbstractTableModel
//******************************************************************************
{
    Q_OBJECT
public: // class methods
    ...
    static QString ClassName() { return "CModelGraphObjConnectionPointGeometry"; }
...
public: // ctors and dtor
    CModelGraphObjConnectionPointGeometry(
    ...
    virtual ~CModelGraphObjConnectionPointGeometry();
signals:
...
protected: // type definitions and constants
    ...
    public: // struct members
        ...
        /*!< True if a line should be drawn from the label showing the value to the
             ...
             For Width and Height this means that a dimension line is drawn.
...
#endif // #ifndef ZSDraw_GraphObjConnectionPointGeometryModel_h
