...
{
    /*  0 */ SEnumEntry( EDrawAttributePenColor,                     XmlStreamParser::c_strXmlAttrPenColor                     ),
    /*  1 */ SEnumEntry( EDrawAttributePenWidth,                     XmlStreamParser::c_strXmlAttrPenWidth                     ),
    /*  2 */ SEnumEntry( EDrawAttributeFillColor,                    XmlStreamParser::c_strXmlAttrFillColor                    ),
    /*  3 */ SEnumEntry( EDrawAttributeFillStyle,                    XmlStreamParser::c_strXmlAttrFillStyle                    ),
    /*  4 */ SEnumEntry( EDrawAttributeLineStyle,                    XmlStreamParser::c_strXmlAttrLineStyle                    ),
    /*  5 */ SEnumEntry( EDrawAttributeLineRecordType,               XmlStreamParser::c_strXmlAttrLineRecordType               ),
    /*  6 */ SEnumEntry( EDrawAttributeLineExtent,                   XmlStreamParser::c_strXmlAttrLineExtent                   ),
    /*  7 */ SEnumEntry( EDrawAttributeLineP1EndStyle,               XmlStreamParser::c_strXmlAttrLineP1EndStyle               ),
    /* 13 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadBaseLineType,  XmlStreamParser::c_strXmlAttrLineP1ArrowHeadBaseLineType  ),
    /* 14 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadFillStyle,     XmlStreamParser::c_strXmlAttrLineP1ArrowHeadFillStyle     ),
    /* 15 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadWidth,         XmlStreamParser::c_strXmlAttrLineP1ArrowHeadWidth         ),
    /* 16 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadLength,        XmlStreamParser::c_strXmlAttrLineP1ArrowHeadLength        ),
    /* 12 */ SEnumEntry( EDrawAttributeLineP2EndStyle,               XmlStreamParser::c_strXmlAttrLineP2EndStyle               ),
    /* 13 */ SEnumEntry( EDrawAttributeLineP2ArrowHeadBaseLineType,  XmlStreamParser::c_strXmlAttrLineP2ArrowHeadBaseLineType  ),
    /* 14 */ SEnumEntry( EDrawAttributeLineP2ArrowHeadFillStyle,     XmlStreamParser::c_strXmlAttrLineP2ArrowHeadFillStyle     ),
    /* 15 */ SEnumEntry( EDrawAttributeLineP2ArrowHeadWidth,         XmlStreamParser::c_strXmlAttrLineP2ArrowHeadWidth         ),
    /* 16 */ SEnumEntry( EDrawAttributeLineP2ArrowHeadLength,        XmlStreamParser::c_strXmlAttrLineP2ArrowHeadLength        ),
    /* 17 */ SEnumEntry( EDrawAttributeTextColor,                    XmlStreamParser::c_strXmlAttrTextColor                    ),
    /* 18 */ SEnumEntry( EDrawAttributeTextFont,                     XmlStreamParser::c_strXmlAttrFont                     ),
    /* 19 */ SEnumEntry( EDrawAttributeTextStyle,                    XmlStreamParser::c_strXmlAttrTextStyle                    ),
    /* 20 */ SEnumEntry( EDrawAttributeTextSize,                     XmlStreamParser::c_strXmlAttrTextSize                     ),
    /* 21 */ SEnumEntry( EDrawAttributeTextEffect,                   XmlStreamParser::c_strXmlAttrTextEffect                   )
};
...
{   // For Undefined GraphObjTypes (used by the drawing scene) each of the attributes is used as default:
    /*  0 PenColor                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrPenColor, QColor(Qt::black), true ),
    ...
    /*  7 LineP1EndStyle               */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1EndStyle, static_cast<int>(ELineEndStyle::Normal), true ),
    /*  8 LineP1ArrowHeadBaseLineType  */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadBaseLineType, static_cast<int>(EArrowHeadBaseLineType::NoLine), true ),
    /*  9 LineP1ArrowHeadFillStyle     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadFillStyle, static_cast<int>(EArrowHeadFillStyle::NoFill), true ),
    /* 10 LineP1ArrowHeadWidth         */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadWidth, static_cast<int>(EArrowHeadWidth::Medium), true ),
    /* 11 LineP1ArrowHeadLength        */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadLength, static_cast<int>(EArrowHeadLength::Medium), true ),
    /* 12 LineP2EndStyle               */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2EndStyle, static_cast<int>(ELineEndStyle::Normal), true ),
    /* 13 LineP2ArrowHeadBaseLineType  */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadBaseLineType, static_cast<int>(EArrowHeadBaseLineType::NoLine), true ),
    /* 14 LineP2ArrowHeadFillStyle     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadFillStyle, static_cast<int>(EArrowHeadFillStyle::NoFill), true ),
    /* 15 LineP2ArrowHeadWidth         */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadWidth, static_cast<int>(EArrowHeadWidth::Medium), true ),
    /* 16 LineP2ArrowHeadLength        */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadLength, static_cast<int>(EArrowHeadLength::Medium), true ),
    /* 17 TextColor                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextColor, QColor(Qt::black), true ),
    /* 18 TextFont                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrFont, QFont("Arial"), true ),
    /* 19 TextStyle                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextStyle, static_cast<int>(ETextStyle::Normal), true ),
    /* 20 TextSize                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextSize, ETextSize11, true ),
    /* 21 TextEffect                   */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextEffect, static_cast<int>(ETextEffect::None), true )
};
...
{   // For UserDefined GraphObjTypes none of the attributes is used as default:
    /*  0 PenColor                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrPenColor, QColor(Qt::black), false ),
    /*  1 PenWidth                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrPenWidth, 1, false),
    /*  2 FillColor                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrFillColor, QColor(Qt::white), false ),
    /*  3 FillStyle                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrFillStyle, static_cast<int>(EFillStyle::NoFill), false ),
    /*  4 LineStyle                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineStyle, static_cast<int>(ELineStyle::SolidLine), false ),
    /*  5 LineRecordType               */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineRecordType, static_cast<int>(ELineRecordType::Normal), false ),
    /*  6 LineExtent                   */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineExtent, 1, false ),
    /*  7 LineP1EndStyle               */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1EndStyle, static_cast<int>(ELineEndStyle::Normal), false ),
    /*  8 LineP1ArrowHeadBaseLineType  */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadBaseLineType, static_cast<int>(EArrowHeadBaseLineType::NoLine), false ),
    /*  9 LineP1ArrowHeadFillStyle     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadFillStyle, static_cast<int>(EArrowHeadFillStyle::NoFill), false ),
    /* 10 LineP1ArrowHeadWidth         */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadWidth, static_cast<int>(EArrowHeadWidth::Medium), false ),
    /* 11 LineP1ArrowHeadLength        */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1ArrowHeadLength, static_cast<int>(EArrowHeadLength::Medium), false ),
    /* 12 LineP2EndStyle               */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2EndStyle, static_cast<int>(ELineEndStyle::Normal), false ),
    /* 13 LineP2ArrowHeadBaseLineType  */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadBaseLineType, static_cast<int>(EArrowHeadBaseLineType::NoLine), false ),
    /* 14 LineP2ArrowHeadFillStyle     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadFillStyle, static_cast<int>(EArrowHeadFillStyle::NoFill), false ),
    /* 15 LineP2ArrowHeadWidth         */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadWidth, static_cast<int>(EArrowHeadWidth::Medium), false ),
    /* 16 LineP2ArrowHeadLength        */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP2ArrowHeadLength, static_cast<int>(EArrowHeadLength::Medium), false ),
    /* 17 TextColor                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextColor, QColor(Qt::black), false ),
    /* 18 TextFont                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrFont, QFont("Arial"), false ),
    /* 19 TextStyle                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextStyle, static_cast<int>(ETextStyle::Normal), false ),
    /* 20 TextSize                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextSize, ETextSize11, false ),
    /* 21 TextEffect                   */ SDrawAttribute( XmlStreamParser::c_strXmlAttrTextEffect, static_cast<int>(ETextEffect::None), false )
};
...
//------------------------------------------------------------------------------
{
    ...
    /*  8 EGraphObjTypeConnectionPoint */ {
        /*  0 PenColor                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrPenColor, QColor(Qt::black), true ),
        /*  1 PenWidth                     */ SDrawAttribute( XmlStreamParser::c_strXmlAttrPenWidth, 1, true),
        /*  2 FillColor                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrFillColor, QColor(Qt::black), true ),
        /*  3 FillStyle                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrFillStyle, static_cast<int>(EFillStyle::SolidPattern), true ),
        /*  4 LineStyle                    */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineStyle, static_cast<int>(ELineStyle::SolidLine), true ),
        /*  5 LineRecordType               */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineRecordType, static_cast<int>(ELineRecordType::Normal), false ),
        /*  6 LineExtent                   */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineExtent, 1, false ),
        /*  7 LineP1EndStyle               */ SDrawAttribute( XmlStreamParser::c_strXmlAttrLineP1EndStyle, static_cast<int>(ELineEndStyle::Normal), false ),
...
//------------------------------------------------------------------------------
{
    ...
    if (isLineStyleUsed()) {
        ...
        if (isLineEndStyleUsed()) {
            ...
            if (IsAttributeUsed(m_graphObjType, iAttribute)) {
                QString strAttr = drawAttribute2Str(iAttribute);
                strAttr = strAttr.remove(XmlStreamParser::c_strXmlAttrLineP1EndStyle);
                if (!str.endsWith("{")) str += ", ";
                str += ", " + strAttr + ": " + attributeValue2Str(iAttribute);
                iSectionsPrint++;
            }
            ...
            if (IsAttributeUsed(m_graphObjType, iAttribute)) {
                QString strAttr = drawAttribute2Str(iAttribute);
                strAttr = strAttr.remove(XmlStreamParser::c_strXmlAttrLineP2EndStyle);
                if (!str.endsWith("{")) str += ", ";
                str += ", " + strAttr + ": " + attributeValue2Str(iAttribute);
                iSectionsPrint++;
            }
