...
#ifndef ZSDraw_GraphObjElectricityCapacitor_h
#define ZSDraw_GraphObjElectricityCapacitor_h
...
CnctPt1 Plates  CnctPt2
          |D|
+--+      |i|      +--+
|  |------|e|------|  |  <-- CnctLine (hidden below plates and dielectric medium)
+--+      |l|      +--+
          |e|
*******************************************************************************/
{
public: // class methods
    ...
    static QString ClassName() { return "CGraphObjCapacitor"; } // Please note that the static class functions name must be different from the non static virtual member function "className"
...
public: // instance methods
    void showCapacitance( ESelectionPoint i_selPtPos = ESelectionPoint::BottomCenter );
    void hideCapacitance();
    bool isCapacitanceVisible( ESelectionPoint i_selPtPos = ESelectionPoint::BottomCenter ) const;
...
protected: // instance members
    ...
    CGraphObjRect*            m_pRctDielectric;
    CGraphObjLine*            m_pLinPlate1;
    CGraphObjLine*            m_pLinPlate2;
    CGraphObjConnectionPoint* m_pCnctPt1;
    CGraphObjConnectionPoint* m_pCnctPt2;
    double                    m_fCapacitance_F; // Farad = C/V = Coulomb/Volt
