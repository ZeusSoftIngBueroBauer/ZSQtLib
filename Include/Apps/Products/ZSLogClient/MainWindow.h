...
#ifndef ZSApps_LogClient_MainWindow_h
#define ZSApps_LogClient_MainWindow_h
...
protected slots:
    void onActFileRecallLoggersTriggered();
    void onActFileSaveLoggersTriggered();
...
protected slots:
    void onLogClientDestroyed( QObject* i_pTrcClient );
    void onLogClientConnected( QObject* i_pTrcClient );
    void onLogClientDisconnected( QObject* i_pTrcClient );
    void onLogClientStateChanged( QObject* i_pTrcClient, int i_iState );
protected slots:
...
protected: // instance members
    ...
    QMenu*                  m_pMnuFile;
    QAction*                m_pActFileRecallLoggers;
    QAction*                m_pActFileSaveLoggers;
    ...
    QLabel*                 m_pLblErrors;
    QWidget*                m_pWdgtLogClientCnctStatus;
    QLabel*                 m_pLblLogClientCnctStatusIcon;
...
#endif // #ifndef ZSApps_LogClient_MainWindow_h
