...
SBK_INCPATH := $(ZSQTLIB_DIR)/Include
SBK_INCPATH := $(SBK_INCPATH);$(ZSQTLIB_DIR)/Make
SBK_INCPATH := $(SBK_INCPATH);$(ZSQTLIB_DIR)/Make/$(MODULE)
SBK_INCPATH := $(SBK_INCPATH);$(PYTHONDIR)/Lib/site-packages/PySide/include/PySide
...
SBK_TYPESYSPATH := $(PYTHONDIR)/Lib/site-packages/PySide/typesystems
