...
const double CGraphObj::c_fStackingOrderOffsetConnectionLines = 0.1;
const double CGraphObj::c_fStackingOrderOffsetConnectionPoints = 0.2;
const double CGraphObj::c_fStackingOrderOffsetLabels = 0.3;
...
const QString CGraphObj::c_strGeometryLabelNameTopCenter = "TC";
const QString CGraphObj::c_strGeometryLabelNameTopRight = "TR";
const QString CGraphObj::c_strGeometryLabelNameRightCenter = "RC";
const QString CGraphObj::c_strGeometryLabelNameBottomRight = "BR";
const QString CGraphObj::c_strGeometryLabelNameBottomCenter = "BC";
const QString CGraphObj::c_strGeometryLabelNameBottomLeft = "BL";
const QString CGraphObj::c_strGeometryLabelNameLeftCenter = "LC";
...
//------------------------------------------------------------------------------
CPhysVal CGraphObj::minimumWidth(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
CPhysVal CGraphObj::minimumHeight(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
    const CDrawingSize& drawingSize = m_pDrawingScene->drawingSize();
...
//------------------------------------------------------------------------------
CPhysValSize CGraphObj::minimumSize(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
CPhysVal CGraphObj::maximumWidth(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
    const CDrawingSize& drawingSize = m_pDrawingScene->drawingSize();
    CPhysVal physValWidth(0.0, drawingSize.unit(), drawingSize.imageCoorsResolution(drawingSize.unit()));
...
//------------------------------------------------------------------------------
CPhysVal CGraphObj::maximumHeight(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
    const CDrawingSize& drawingSize = m_pDrawingScene->drawingSize();
    CPhysVal physValHeight(0.0, drawingSize.unit(), drawingSize.imageCoorsResolution(drawingSize.unit()));
...
//------------------------------------------------------------------------------
CPhysValSize CGraphObj::maximumSize(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
    CPhysValSize physValSize(*m_pDrawingScene);
    if (m_physValSizeFixed.isValid()) {
...
//------------------------------------------------------------------------------
CPhysVal CGraphObj::fixedWidth(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
    const CDrawingSize& drawingSize = m_pDrawingScene->drawingSize();
    CPhysVal physValWidth(0.0, drawingSize.unit(), drawingSize.imageCoorsResolution(drawingSize.unit()));
...
//------------------------------------------------------------------------------
CPhysVal CGraphObj::fixedHeight(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
    const CDrawingSize& drawingSize = m_pDrawingScene->drawingSize();
    CPhysVal physValHeight(0.0, drawingSize.unit(), drawingSize.imageCoorsResolution(drawingSize.unit()));
...
//------------------------------------------------------------------------------
bool CGraphObj::isResizable() const
//------------------------------------------------------------------------------
{
    return !hasFixedSize();
}
...
//------------------------------------------------------------------------------
CPhysValSize CGraphObj::fixedSize(const CUnit& i_unit) const
//------------------------------------------------------------------------------
{
    CPhysValSize physValSize(*m_pDrawingScene);
    if (m_physValSizeFixed.isValid()) {
...
/*! @brief Adds a new connection point with the given name anchored to the given
    ...
    @param [in] i_strName
        Name of the connection point. The name must be unique otherwise the
        connection point is not added.
    @param [in] i_selPtType
        Selection point type.
        Range [BoundingRectangle]
    @param [in] i_selPt
    ...
    @return true, if the connection point has been created and added, false otherwise.
*/
...
//------------------------------------------------------------------------------
/*! @brief Adds a new connection point anchored to the given selection point at
           the bounding rectangle.

    For the connection point a unique name is created containing the selection point
    the connection point is anchored to. The unique name is returned by the method.
...
//------------------------------------------------------------------------------
{
    ...
    addConnectionPoint(strName, i_selPtType, i_selPt);
...
//------------------------------------------------------------------------------
/*! @brief Adds a new connection point anchored to the given polygon shape point.

    For the connection point a unique name is created containing the shape point
    the connection point is anchored to. The unique name is returned by the method.
...
//------------------------------------------------------------------------------
{
    ...
    addConnectionPoint(strName, i_selPtType, i_idxPt);
