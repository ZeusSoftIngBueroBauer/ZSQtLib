...
//------------------------------------------------------------------------------
CObjFactoryDiode::CObjFactoryDiode(
...
//------------------------------------------------------------------------------
    CObjFactory(
        ...
        /* strGraphObjClassName */ "CGraphObjDiode",
...
//------------------------------------------------------------------------------
{
    ...
    CGraphObj* pGraphObj = new CGraphObjDiode(
...
//------------------------------------------------------------------------------
SErrResultInfo CObjFactoryDiode::saveGraphObj(
...
//------------------------------------------------------------------------------
{
    ...
    CGraphObjDiode* pGraphObj = dynamic_cast<CGraphObjDiode*>(i_pGraphObj);
    ...
    i_xmlStreamWriter.writeTextElement( "CutOffVoltage", QString::number(pGraphObj->getCutOffVoltage()) );
...
//------------------------------------------------------------------------------
CGraphObj* CObjFactoryDiode::loadGraphObj(
    CDrawingScene*    i_pDrawingScene,
...
//------------------------------------------------------------------------------
{
    ...
    if( i_pDrawingScene->findGraphObj(i_strObjId) == nullptr )
    {
        ...
        double                           fCutOffVoltage_V = 1000.0;
        QPointF                          ptPos;
        QSizeF                           siz;
        ...
        while( !i_xmlStreamReader.hasError() && !i_xmlStreamReader.atEnd() )
        {
            ...
            if( i_xmlStreamReader.isStartElement() )
            {
                ...
                else if( strElemName == "CutOffVoltage" )
                {
        ...
        if( bPosValid && bSizeValid )
        {
            ...
            pGraphObj->setCutOffVoltage(fCutOffVoltage_V);
...
//------------------------------------------------------------------------------
void CObjFactoryDiode::ResetCtorsDtorsCounters()
//------------------------------------------------------------------------------
{
    CGraphObjDiode::ResetCtorsDtorsCounters();
}
