...
/*******************************************************************************
class CWdgtGraphObjConnectionLineGeometryProperties : public CWdgtGraphObjPropertiesAbstract
*******************************************************************************/
...
//------------------------------------------------------------------------------
CWdgtGraphObjConnectionLineGeometryProperties::CWdgtGraphObjConnectionLineGeometryProperties(
...
//------------------------------------------------------------------------------
    CWdgtGraphObjPropertiesAbstract(
        i_pDrawingScene,
        i_strNameSpace, "Connections::ConnectionLine", ClassName(),
    ...
    //m_pDlgEditProperty(nullptr)
{
    ...
    QObject::connect(
        ...
        this, &CWdgtGraphObjConnectionLineGeometryProperties::onBtnCollapseClicked);
    ...
    QObject::connect(
        ...
        this, &CWdgtGraphObjConnectionLineGeometryProperties::onBtnResizeRowsAndColumnsToContentsClicked );
    ...
    m_pModelGeometry = new CModelGraphObjConnectionLineGeometry(
        m_pDrawingScene, i_strNameSpace, "Connections::ConnectionLine",
        i_strObjName, CEnumScaleDimensionUnit(), this);
    m_pTableViewGeometry = new CTableViewGraphObjConnectionLineGeometry(i_strObjName);
    ...
    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnXVal, m_pEdtPhysValDelegateXVal);
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnXVal, CTableView::SEditTriggerKey(Qt::Key_Return));

    m_pEdtPhysValDelegateYVal =
        new CEditPhysValtemDelegate(m_pModelGeometry, m_pTableViewGeometry);
    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnYVal, m_pEdtPhysValDelegateYVal);
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnYVal, CTableView::SEditTriggerKey(Qt::Key_Return));

    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnShowVals,
        new CCheckBoxItemDelegate(m_pModelGeometry, m_pTableViewGeometry));
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnShowVals, CTableView::SEditTriggerKey(Qt::Key_Return));

    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnShowLine,
        new CCheckBoxItemDelegate(m_pModelGeometry, m_pTableViewGeometry));
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjConnectionLineGeometry::EColumnShowLine, CTableView::SEditTriggerKey(Qt::Key_Return));
    ...
    QObject::connect(
        m_pModelGeometry, &CModelGraphObjConnectionLineGeometry::contentChanged,
        this, &CWdgtGraphObjConnectionLineGeometryProperties::onModelGeometryContentChanged);
...
//------------------------------------------------------------------------------
void CWdgtGraphObjConnectionLineGeometryProperties::expand(bool i_bExpand)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
bool CWdgtGraphObjConnectionLineGeometryProperties::setKeyInTree(const QString& i_strKeyInTree)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObj, EMethodTraceDetailLevel::ArgsNormal)) {
...
//------------------------------------------------------------------------------
bool CWdgtGraphObjConnectionLineGeometryProperties::hasErrors() const
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
bool CWdgtGraphObjConnectionLineGeometryProperties::hasChanges() const
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjConnectionLineGeometryProperties::acceptChanges()
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjConnectionLineGeometryProperties::rejectChanges()
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjConnectionLineGeometryProperties::onBtnCollapseClicked(bool /*i_bChecked*/)
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjConnectionLineGeometryProperties::onBtnResizeRowsAndColumnsToContentsClicked(bool /*i_bChecked*/)
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjConnectionLineGeometryProperties::onModelGeometryContentChanged()
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
////------------------------------------------------------------------------------
//void CWdgtGraphObjConnectionLineGeometryProperties::onDlgEditPropertyDestroyed(QObject* i_pObj)
////------------------------------------------------------------------------------
//{
//    CMethodTracer mthTracer(
//        /* pAdminObj    */ m_pTrcAdminObj,
...
*/
//void CWdgtGraphObjConnectionLineGeometryProperties::registerEditPropertyDialog(CWdgtEditPhysVal* i_pEdtWidget)
//------------------------------------------------------------------------------
//{
//    QString strMthInArgs;
//    if (areMethodCallsActive(m_pTrcAdminObj, EMethodTraceDetailLevel::ArgsNormal)) {
...
*/
//bool CWdgtGraphObjConnectionLineGeometryProperties::eventFilter(QObject* i_pObjWatched, QEvent* i_pEv)
//------------------------------------------------------------------------------
//{
//    bool bHandled = false;
...
//                        this, &CWdgtGraphObjConnectionLineGeometryProperties::onDlgEditPropertyDestroyed);
//                }
