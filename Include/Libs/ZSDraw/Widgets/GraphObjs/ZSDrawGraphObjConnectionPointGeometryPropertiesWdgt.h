...
#ifndef ZSDraw_DrawGraphObjConnectionPointGeometryPropertiesWdgt_h
#define ZSDraw_DrawGraphObjConnectionPointGeometryPropertiesWdgt_h
...
namespace Draw
{
class CModelGraphObjConnectionPointGeometry;

//******************************************************************************
class ZSDRAWDLL_API CWdgtGraphObjConnectionPointGeometryProperties : public CWdgtGraphObjPropertiesAbstract
//******************************************************************************
{
    Q_OBJECT
public: // class methods
    ...
    static QString ClassName() { return "CWdgtGraphObjConnectionPointGeometryProperties"; }
public: // ctors and dtor
    CWdgtGraphObjConnectionPointGeometryProperties(
        CDrawingScene* i_pDrawingScene,
        const QString& i_strNameSpace,
        const QString& i_strObjName,
        QWidget* i_pWdgtParent = nullptr);
    virtual ~CWdgtGraphObjConnectionPointGeometryProperties();
...
private: // instance members
    ...
    CModelGraphObjConnectionPointGeometry* m_pModelGeometry;

}; // class CWdgtGraphObjConnectionPointGeometryProperties

} // namespace Draw

} // namespace ZS

#endif // #ifndef ZSDraw_DrawGraphObjConnectionPointGeometryPropertiesWdgt_h
