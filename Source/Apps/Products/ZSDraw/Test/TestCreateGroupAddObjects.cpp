...
//------------------------------------------------------------------------------
{
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_LINES_SMALLPLUSSIGN == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_LINES_BIGPLUSSIGN == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_LINES_CHECKMARK == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_LINES_SMALLRECT == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_RECTANGLES == 1
    ...
    createTestStepSaveLoadFile(pGrpRectangles, 1);

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_RECTANGLES
    ...
    createTestGroupAddStandardShapesEllipse(pGrpEllipsesEllipse);
    createTestGroupAddStandardShapesEllipseModifications(pGrpEllipsesEllipse);

    if (bUnitPixel) {
        //createTestStepSaveLoadFile(pGrpEllipses, 3);
    }
    else {
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_POLYGONS_TRIANGLE == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_POLYGONS_OPEN_ARROW == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_NOT_ANCHORED == 1
    ...
    createTestGroupAddStandardShapesConnectionPointsNotAnchored(pGrpConnectionPointsNotAnchored);
    createTestGroupAddStandardShapesConnectionPointsNotAnchoredModifications(pGrpConnectionPointsNotAnchored);

    createTestStepSaveLoadFile(pGrpConnectionPointsNotAnchored, 1);
#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_NOT_ANCHORED

#if TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_ANCHORED == 1
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_ANCHORED_TOLINES == 1
    ...
    createTestGroupAddStandardShapesConnectionPointsAnchoredToLines(pGrpConnectionPointsAnchoredToLines);
    createTestGroupAddStandardShapesConnectionPointsAnchoredToLinesModifications(pGrpConnectionPointsAnchoredToLines);

    createTestStepSaveLoadFile(pGrpConnectionPointsAnchoredToLines, 1);
#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_ANCHORED_TOLINES

#if TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_ANCHORED_TORECTS == 1
    ...
    createTestGroupAddStandardShapesConnectionPointsAnchoredToRects(pGrpConnectionPointsAnchoredToRects);
    createTestGroupAddStandardShapesConnectionPointsAnchoredToRectsModifications(pGrpConnectionPointsAnchoredToRects);

    createTestStepSaveLoadFile(pGrpConnectionPointsAnchoredToRects, 1);

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_ANCHORED_TORECTS
#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS_ANCHORED
#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_CONNECTIONPOINTS
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_SMALLPLUSSIGN == 1
    ...
    createTestGroupAddStandardShapesGroupLinesSmallPlusSign(pGrpGroupsSmallPlusSignAddShapes);
    createTestGroupAddStandardShapesGroupLinesSmallPlusSignResize(pGrpGroupsSmallPlusSign);
    createTestStepSaveLoadFile(pGrpGroupsSmallPlusSign);

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_SMALLPLUSSIGN

    // BigPlusSign
    //------------

#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_BIGPLUSSIGN == 1
    ...
    createTestGroupAddStandardShapesGroupLinesBigPlusSign(pGrpGroupsBigPlusSignRotateTopAddShapes);
    createTestGroupAddStandardShapesGroupLinesBigPlusSignRotateParent(pGrpGroupsBigPlusSignRotateTop);
    ...
    createTestGroupAddStandardShapesGroupLinesBigPlusSign(pGrpGroupsBigPlusSignRotateAndResizeAddShapes);
    createTestGroupAddStandardShapesGroupLinesBigPlusSignModfications(pGrpGroupsBigPlusSignRotateAndResize);
    createTestStepSaveLoadFile(pGrpGroupsBigPlusSignRotateAndResize, 2);

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_BIGPLUSSIGN == 1

    // PlusSigns
    //----------

#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_PLUSSIGNS == 1
    ...
    createTestGroupAddStandardShapesGroupLinesPlusSigns(pGrpGroupsPlusSignsAddShapes);
    createTestGroupAddStandardShapesGroupLinesPlusSignsModifications(pGrpGroupsPlusSigns);
    createTestStepSaveLoadFile(pGrpGroupsPlusSigns, 1);

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_PLUSSIGNS

    // Checkmark
    //------------

#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_CHECKMARK == 1
    ...
    createTestGroupAddStandardShapesGroupLinesCheckmark(pGrpGroupsCheckmarkAddShapes);
    createTestGroupAddStandardShapesGroupLinesCheckmarkModifications(pGrpGroupsCheckmark);
    createTestStepSaveLoadFile(pGrpGroupsCheckmark);

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_LINES_CHECKMARK

    // Rectangles
    //-----------

#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_RECTANGLES == 1

    ZS::Test::CTestStepGroup* pGrpGroupsRectangles = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " "  + c_strGraphObjNameCrosses + " by Rectangles",
        /* pTSGrpParent */ pGrpGroups );
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " Clear Drawing",
        /* strOperation    */ "DrawingScene.clear",
        /* pGrpParent      */ pGrpGroupsRectangles,
        /* szDoTestStepFct */ SLOT(doTestStepClearDrawingScene(ZS::Test::CTestStep*)) );
    pTestStep->setExpectedValue("");
    ...
    ZS::Test::CTestStepGroup* pGrpGroupsRectanglesAddShapes = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Add Shapes",
        /* pTSGrpParent */ pGrpGroupsRectangles );

    createTestGroupAddStandardShapesGroupRectsCrosses(pGrpGroupsRectanglesAddShapes);
    createTestGroupAddStandardShapesGroupRectsCrossesModifications(pGrpGroupsRectangles);
    if (!bUnitPixel) {
        createTestStepSaveLoadFile(pGrpGroupsRectangles, 2);
    }

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_RECTANGLES

    // Ellipses
    //-----------

#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_ELLIPSES == 1

    ZS::Test::CTestStepGroup* pGrpGroupsEllipses = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " "  + c_strGraphObjNameCrosses + " by Ellipses",
        /* pTSGrpParent */ pGrpGroups );
    ...
    ZS::Test::CTestStepGroup* pGrpGroupsEllipsesAddShapes = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Add Shapes",
        /* pTSGrpParent */ pGrpGroupsEllipses );

    createTestGroupAddStandardShapesGroupEllipsesCrosses(pGrpGroupsEllipsesAddShapes);
    createTestGroupAddStandardShapesGroupEllipsesCrossesModifications(pGrpGroupsEllipses);
    if (bUnitPixel) {
        //createTestStepSaveLoadFile(pGrpGroupsEllipses, 3);
    }
    else {
        createTestStepSaveLoadFile(pGrpGroupsEllipses, 2);
    }

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_ELLIPSES

    // Texts
    //------

#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_TEXTS == 1

    ZS::Test::CTestStepGroup* pGrpGroupsTexts = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " "  + c_strGraphObjNameCrosses + " by Texts",
        /* pTSGrpParent */ pGrpGroups );
    ...
    ZS::Test::CTestStepGroup* pGrpGroupsTextsAddShapes = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Add Shapes",
        /* pTSGrpParent */ pGrpGroupsTexts );
...
#if TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_CONNECTIONPOINTS == 1

    ZS::Test::CTestStepGroup* pGrpGroupsConnections = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Connections",
        /* pTSGrpParent */ pGrpGroups );

    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPoints = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " ConnectionPoints",
        /* pTSGrpParent */ pGrpGroupsConnections );

    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPointsNotAnchored = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " NotAnchored ConnectionPoints",
        /* pTSGrpParent */ pGrpGroupsConnectionPoints );

    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " Clear Drawing",
        /* strOperation    */ "DrawingScene.clear",
        /* pGrpParent      */ pGrpGroupsConnectionPointsNotAnchored,
        /* szDoTestStepFct */ SLOT(doTestStepClearDrawingScene(ZS::Test::CTestStep*)) );
    pTestStep->setExpectedValue("");
    ...
    createTestGroupAddStandardShapesGroupConnectionPointsNotAnchored(pGrpGroupsConnectionPointsNotAnchored);
    createTestStepSaveLoadFile(pGrpGroupsConnectionPointsNotAnchored, 3);

    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPointsAnchored = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Anchored ConnectionPoints",
        /* pTSGrpParent */ pGrpGroupsConnectionPoints );
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " Clear Drawing",
        /* strOperation    */ "DrawingScene.clear",
        /* pGrpParent      */ pGrpGroupsConnectionPointsAnchored,
        /* szDoTestStepFct */ SLOT(doTestStepClearDrawingScene(ZS::Test::CTestStep*)) );
    pTestStep->setExpectedValue("");
    ...
    createTestGroupAddStandardShapesGroupConnectionPointsAnchored(pGrpGroupsConnectionPointsAnchored);
    createTestStepSaveLoadFile(pGrpGroupsConnectionPointsAnchored, 1);

#endif // TEST_ADD_OBJECTS_STANDARDSHAPES_GROUPS_CONNECTIONPOINTS
...
//------------------------------------------------------------------------------
{
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineSmallPlusSignVerticalLine, *m_pPhysValLineSmallPlusSignVerticalLine, false));
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineSmallPlusSignHorizontalLine, *m_pPhysValLineSmallPlusSignHorizontalLine, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
}
...
//------------------------------------------------------------------------------
{
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineCheckmarkLeftLine, *m_pPhysValLineCheckmarkLeftLine, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineCheckmarkRightLine, *m_pPhysValLineCheckmarkRightLine, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
}
...
//------------------------------------------------------------------------------
{
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineSmallRectTopLine, *m_pPhysValLineSmallRectTopLine, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineSmallRectRightLine, *m_pPhysValLineSmallRectRightLine, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineSmallRectBottomLine, *m_pPhysValLineSmallRectBottomLine, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.append(resultValuesForLine(
        ...
        m_lineSmallRectLeftLine, *m_pPhysValLineSmallRectLeftLine, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
}

//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesRect(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesRect",
        /* strAddInfo   */ strMthInArgs );
    ...
    m_ptPosRect1 = QPointF(300.0, 300.0);
    QPointF ptCenterRectangle(300.0, bYAxisTopDown ? 300.0 : fYAxisMaxVal - 300.0);
    ...
    m_pPhysValRect1->setCenter(ptCenterRectangle);
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesRectModifications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesRectModifications",
        /* strAddInfo   */ strMthInArgs );
    ...
    strMethod = "setSize";
    strMthArgs = qSize2Str(sizeRectangle);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesEllipse(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesEllipse",
        /* strAddInfo   */ strMthInArgs );
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* strOperation    */ strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ i_pTestStepGroupParent,
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjEllipse(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strObjName));
    m_ptPosEllipse = QPointF(300.0, bYAxisTopDown ? 300.0 : fYAxisMaxVal - 300.0);
    QSizeF sizeEllipse(50.0, 50.0);
    m_rectEllipse = QRectF(QPointF(-sizeEllipse.width()/2.0, -sizeEllipse.height()/2.0), sizeEllipse);
    m_pPhysValRectEllipse->setSize(sizeEllipse);
    m_pPhysValRectEllipse->setCenter(m_ptPosEllipse);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
    ...
    strlstExpectedValues.append(resultValuesForEllipse(
        c_strGraphObjNameEllipse, m_ptPosEllipse, m_rectEllipse, *m_pPhysValRectEllipse, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
}

//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesEllipseModifications(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesEllipseModifications",
        /* strAddInfo   */ strMthInArgs );
    ...
    strMethod = "setWidth";
    strMthArgs = QString::number(sizeEllipse.width()) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyEllipse,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjEllipseByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_ptPosEllipse = QPointF(325.0, 300.0);
    m_rectEllipse = QRectF(QPointF(-sizeEllipse.width()/2.0, -sizeEllipse.height()/2.0), sizeEllipse);
    m_pPhysValRectEllipse->setSize(sizeEllipse);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Width", m_rectEllipse.width());
    pTestStep->setConfigValue("Width.unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForEllipse(
        strObjName, m_ptPosEllipse, m_rectEllipse, *m_pPhysValRectEllipse, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    iResultValuesPrecision = 6;
    m_physValAngleEllipse.setVal(45.0);
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleEllipse.toString();
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyEllipse,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjEllipseByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_pPhysValRectEllipse->setAngle(m_physValAngleEllipse);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Angle", m_physValAngleEllipse.toString());
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForEllipse(
        strObjName, m_ptPosEllipse, m_rectEllipse, *m_pPhysValRectEllipse, false, iResultValuesPrecision));
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    iResultValuesPrecision = 6;
    sizeEllipse = m_pPhysValRectEllipse->size().toQSizeF();
    sizeEllipse.setHeight(100.0);
    strMethod = "setHeight";
    strMthArgs = QString::number(sizeEllipse.height()) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyEllipse,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjEllipseByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_ptPosEllipse = QPointF(bYAxisTopDown ? 307.322330 : 342.677670, bYAxisTopDown ? 317.677670 : fYAxisMaxVal - 317.677670);
    m_rectEllipse = QRectF(QPointF(-sizeEllipse.width()/2.0, -sizeEllipse.height()/2.0), sizeEllipse);
    m_pPhysValRectEllipse->setSize(sizeEllipse);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Height", m_rectEllipse.height());
    pTestStep->setConfigValue("Height.unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForEllipse(
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    iResultValuesPrecision = 6;
    sizeEllipse = QSizeF(150.0, 150.0);
    strMethod = "setSize";
    strMthArgs = qSize2Str(sizeEllipse);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyEllipse,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjEllipseByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_ptPosEllipse = QPointF(bYAxisTopDown ? 307.322330 : 378.033009, bYAxisTopDown ? 353.033009 : fYAxisMaxVal - 317.677670);
    m_rectEllipse = QRectF(QPointF(-sizeEllipse.width()/2.0, -sizeEllipse.height()/2.0), sizeEllipse);
    m_pPhysValRectEllipse->setSize(sizeEllipse);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Size", m_rectEllipse.size());
    pTestStep->setConfigValue("Size.unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForEllipse(
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* pGrpParent      */ pGrpModifyEllipse,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjEllipseByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_ptPosEllipse = QPointF(bYAxisTopDown ? 271.966991 : 342.677670, bYAxisTopDown ? 317.677670 : fYAxisMaxVal - 353.033009);
    m_rectEllipse = QRectF(QPointF(-sizeEllipse.width()/2.0, -sizeEllipse.height()/2.0), sizeEllipse);
    m_pPhysValRectEllipse->setSize(sizeEllipse);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    iResultValuesPrecision = 6;
    m_physValAngleEllipse.setVal(0.0);
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleEllipse.toString();
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* pGrpParent      */ pGrpModifyEllipse,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjEllipseByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_ptPosEllipse = QPointF(bYAxisTopDown ? 271.966991 : 342.677670, bYAxisTopDown ? 267.677670 : fYAxisMaxVal - 303.033009);
    m_rectEllipse = QRectF(QPointF(-sizeEllipse.width()/2.0, -sizeEllipse.height()/2.0), sizeEllipse);
    m_pPhysValRectEllipse->setSize(sizeEllipse);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesText(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesText",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesTextModifications(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesTextModifications",
        /* strAddInfo   */ strMthInArgs );
    ...
    pTestStep->addDataRow({
        ...
        {"GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]},
        {"LabelName", CGraphObj::c_strGeometryLabelNameCenter},
        {"setPos", QPointF(280.0, 370.0)},
        {"ExpectedText", m_pPhysValRectText->center().toString()},
    });
    pTestStep->addDataRow({
        {"GraphObjName", strObjName},
        {"GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]},
        {"LabelName", CGraphObj::c_strGeometryLabelNameWidth},
        {"setPos", QPointF(290.0, 430.0)},
        {"ExpectedText", QString::number(m_pPhysValRectText->width().getVal(), 'f', iResultValuesPrecision)},
    });
    pTestStep->addDataRow({
        {"GraphObjName", strObjName},
        {"GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]},
        {"LabelName", CGraphObj::c_strGeometryLabelNameHeight},
        {"setPos", QPointF(250.0, 395.0)},
        {"ExpectedText", QString::number(m_pPhysValRectText->height().getVal(), 'f', iResultValuesPrecision)},
    });
    pTestStep->addDataRow({
        {"GraphObjName", strObjName},
        {"GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]},
        {"LabelName", CGraphObj::c_strGeometryLabelNameAngle},
        {"setPos", QPointF(350.0, 410.0)},
        {"ExpectedText", m_physValAngleText.toString()},
    });
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    //iResultValuesPrecision = 6;
    QSizeF sizeText = m_pPhysValRectText->size().toQSizeF();
    sizeText.setWidth(100.0);
    strMethod = "setWidth";
    strMthArgs = QString::number(sizeText.width()) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyText,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjTextByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_pPhysValRectText->setSize(sizeText);
    m_ptPosText.setX(m_pPhysValRectText->center().toQPointF().x());
    m_ptPosText.setY(bYAxisTopDown ? m_pPhysValRectText->center().toQPointF().y() : fYAxisMaxVal - m_pPhysValRectText->center().toQPointF().y());
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    ...
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Width", sizeText.width());
    pTestStep->setConfigValue("Width.unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForText(
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    iResultValuesPrecision = 6;
    m_physValAngleText.setVal(45.0);
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleText.toString();
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyText,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjTextByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_pPhysValRectText->setAngle(m_physValAngleText);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Angle", m_physValAngleText.toString());
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForText(
        strObjName, m_ptPosText, *m_pPhysValRectText, strText, false, iResultValuesPrecision));
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    iResultValuesPrecision = 6;
    sizeText = m_pPhysValRectText->size().toQSizeF();
    sizeText.setHeight(100.0);
    strMethod = "setHeight";
    strMthArgs = QString::number(sizeText.height()) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Height", sizeText.height());
    pTestStep->setConfigValue("Height.unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForText(
    ...
    iResultValuesPrecision = bUnitPixel ? 0 : drawingSize.metricImageCoorsDecimals();
    iResultValuesPrecision = 6;
    sizeText = QSizeF(150.0, 150.0);
    strMethod = "setSize";
    strMthArgs = qSize2Str(sizeText);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Size", sizeText);
    pTestStep->setConfigValue("Size.unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForText(
...
//------------------------------------------------------------------------------
{
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForPolygon(
        strObjName, m_ptPosTriangle, m_polygonTriangle, *m_pPhysValPolygonTriangle, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesConnectionPointsNotAnchored(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesConnectionPointsNotAnchored",
        /* strAddInfo   */ strMthInArgs );
    ...
    ZS::Test::CTestStepGroup* pGrpAddCncts = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
    ...
    *m_pPhysValConnectionPoint3 = QPointF(600.0, bYAxisTopDown ? 250.0 : fYAxisMaxVal - 250.0);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("Point", m_pPhysValConnectionPoint3->toQPointF());
    pTestStep->setConfigValue("Point.Unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
    ...
    *m_pPhysValConnectionPoint4 = QPointF(600.0, bYAxisTopDown ? 350.0 : fYAxisMaxVal - 350.0);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("Point", m_pPhysValConnectionPoint4->toQPointF());
    pTestStep->setConfigValue("Point.Unit", strUnit);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
    ...
    *m_pPhysValPolygonConnectionLineCnctPt3CnctPt4 = QPolygonF({
    ...
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("GraphObjKeyInTreeCnctPt1", m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionPoint3]);
    pTestStep->setConfigValue("GraphObjKeyInTreeCnctPt2", m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionPoint4]);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForConnectionLine(
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesConnectionPointsNotAnchoredModifications(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesConnectionPointsNotAnchoredModifications",
        /* strAddInfo   */ strMthInArgs );
    ...
    *m_pPhysValConnectionPoint1 = QPointF(300.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0);
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyCnctPts,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjConnectionPointByDirectMethodCalls(ZS::Test::CTestStep*)) );
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    ...
    *m_pPhysValPolygonConnectionLineCnctPt1CnctPt4 = QPolygonF({
    ...
    strGraphObjName = c_strGraphObjNameConnectionPoint2;
    strMethod = "setPosition";
    m_ptPosConnectionPoint2 = QPointF(300.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0);
    *m_pPhysValConnectionPoint2 = QPointF(300.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0);
    strMthArgs = qPoint2Str(m_ptPosConnectionPoint2) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    *m_pPhysValPolygonConnectionLineCnctPt3CnctPt2 = QPolygonF({
    ...
    strGraphObjName = c_strGraphObjNameConnectionPoint3;
    strMethod = "setPosition";
    m_ptPosConnectionPoint3 = QPointF(500.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0);
    *m_pPhysValConnectionPoint3 = QPointF(500.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0);
    strMthArgs = qPoint2Str(m_ptPosConnectionPoint3) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    *m_pPhysValPolygonConnectionLineCnctPt3CnctPt2 = QPolygonF({
    ...
    strGraphObjName = c_strGraphObjNameConnectionPoint4;
    strMethod = "setPosition";
    m_ptPosConnectionPoint4 = QPointF(500.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0);
    *m_pPhysValConnectionPoint4 = QPointF(500.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0);
    strMthArgs = qPoint2Str(m_ptPosConnectionPoint2) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    *m_pPhysValPolygonConnectionLineCnctPt1CnctPt4 = QPolygonF({
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyCnctPts,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjConnectionLineByDirectMethodCalls(ZS::Test::CTestStep*)) );
    m_polygonConnectionLineCnctPt1CnctPt2 = QPolygonF({
        { 10.0, -100.0},
        {-10.0,  -50.0},
        { 10.0,  100.0}
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesConnectionPointsAnchoredToLines(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesConnectionPointsAnchoredToLines",
        /* strAddInfo   */ strMthInArgs );
    ...
    QString strGraphObjName;
    QString strGraphObjCnctPtName;
    QString strGraphObjCnctPt1Name;
    QString strGraphObjCnctPt2Name;
    CEnumSelectionPointType eSelPtTypePolygonPoint(ESelectionPointType::PolygonPoint);
    CEnumSelectionPointType eSelPtTypeLineCenterPoint(ESelectionPointType::LineCenterPoint);
    int idxPt, idxLine;
    QPointF ptPosCnctPt;
    CPhysValPoint physValCnctPt(*m_pDrawingScene);
    QString strMethod;
    QString strMthArgs;
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjLine(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strGraphObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strGraphObjName));
    QPointF ptPosLine1Pt1(175.0, 225.0);
    QPointF ptPosLine1Pt2(225.0, 275.0);
    m_ptPosLine1 = QPointF(200.0, 250.0);
    m_lineLine1 = QLineF(QPointF(-25.0, -25.0), QPointF(25.0, 25.0));
    m_pPhysValLine1->setP1(QPointF(ptPosLine1Pt1.x(), bYAxisTopDown ? ptPosLine1Pt1.y() : fYAxisMaxVal - ptPosLine1Pt1.y()));
    m_pPhysValLine1->setP2(QPointF(ptPosLine1Pt2.x(), bYAxisTopDown ? ptPosLine1Pt2.y() : fYAxisMaxVal - ptPosLine1Pt2.y()));
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("P1", m_pPhysValLine1->p1().toQPointF());
    pTestStep->setConfigValue("P2", m_pPhysValLine1->p2().toQPointF());
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForLine(
        strGraphObjName, m_ptPosLine1, m_lineLine1, *m_pPhysValLine1, false));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 1 - Pt1
    //------------------------------

    strGraphObjKeyInTreeParent = pIdxTree->buildKeyInTreeStr(strEntryType, c_strGraphObjNameLine1);
    idxPt = 0;
    strGraphObjName = "CnctPoint-P" + QString::number(idxPt) + "-1";
    strMethod = c_strGraphObjNameLine1 + "." + "addConnectionPoint";
    strMthArgs = eSelPtTypePolygonPoint.toString() + ", " + QString::number(idxPt);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("SelectionPointType", eSelPtTypePolygonPoint.toString());
    pTestStep->setConfigValue("Point", idxPt);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine1Pt1;
    physValCnctPt = m_pPhysValLine1->p1();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 1 - Pt2
    //------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine1Pt2;
    physValCnctPt = m_pPhysValLine1->p2();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 1 - LineCenter
    //-------------------------------------

    strGraphObjKeyInTreeParent = pIdxTree->buildKeyInTreeStr(strEntryType, c_strGraphObjNameLine1);
    idxLine = 0;
    strGraphObjName = "CnctPoint-L" + QString::number(idxLine) + "-1";
    strMethod = c_strGraphObjNameLine1 + "." + "addConnectionPoint";
    strMthArgs = eSelPtTypeLineCenterPoint.toString() + ", " + QString::number(idxLine);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strMethod + "(" + strMthArgs + ")",
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjConnectionPoint(ZS::Test::CTestStep*)) );
    pTestStep->setConfigValue("GraphObjKeyInTreeParent", strGraphObjKeyInTreeParent);
    pTestStep->setConfigValue("SelectionPointType", eSelPtTypeLineCenterPoint.toString());
    pTestStep->setConfigValue("Line", idxLine);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = m_ptPosLine1;
    physValCnctPt = m_pPhysValLine1->center();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjLine(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strGraphObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strGraphObjName));
    QPointF ptPosLine2Pt1(175.0, 375.0);
    QPointF ptPosLine2Pt2(225.0, 325.0);
    m_ptPosLine2 = QPointF(200.0, 350.0);
    m_lineLine2 = QLineF(QPointF(-25.0, 25.0), QPointF(25.0, -25.0));
    m_pPhysValLine2->setP1(QPointF(ptPosLine2Pt1.x(), bYAxisTopDown ? ptPosLine2Pt1.y() : fYAxisMaxVal - ptPosLine2Pt1.y()));
    m_pPhysValLine2->setP2(QPointF(ptPosLine2Pt2.x(), bYAxisTopDown ? ptPosLine2Pt2.y() : fYAxisMaxVal - ptPosLine2Pt2.y()));
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("P1", m_pPhysValLine2->p1().toQPointF());
    pTestStep->setConfigValue("P2", m_pPhysValLine2->p2().toQPointF());
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForLine(
        strGraphObjName, m_ptPosLine2, m_lineLine2, *m_pPhysValLine2, false));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 2 - Pt1
    //------------------------------

    strGraphObjKeyInTreeParent = pIdxTree->buildKeyInTreeStr(strEntryType, c_strGraphObjNameLine2);
    idxPt = 0;
    strGraphObjName = "CnctPoint-P" + QString::number(idxPt) + "-1";
    strMethod = c_strGraphObjNameLine2 + "." + "addConnectionPoint";
    strMthArgs = eSelPtTypePolygonPoint.toString() + ", " + QString::number(idxPt);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine2Pt1;
    physValCnctPt = m_pPhysValLine2->p1();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 2 - Pt2
    //------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine2Pt2;
    physValCnctPt = m_pPhysValLine2->p2();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 2 - LineCenter
    //-------------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = m_ptPosLine2;
    physValCnctPt = m_pPhysValLine2->center();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjLine(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strGraphObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strGraphObjName));
    QPointF ptPosLine3Pt1(575.0, 275.0);
    QPointF ptPosLine3Pt2(625.0, 225.0);
    m_ptPosLine3 = QPointF(600.0, 250.0);
    m_lineLine3 = QLineF(QPointF(-25.0, 25.0), QPointF(25.0, -25.0));
    m_pPhysValLine3->setP1(QPointF(ptPosLine3Pt1.x(), bYAxisTopDown ? ptPosLine3Pt1.y() : fYAxisMaxVal - ptPosLine3Pt1.y()));
    m_pPhysValLine3->setP2(QPointF(ptPosLine3Pt2.x(), bYAxisTopDown ? ptPosLine3Pt2.y() : fYAxisMaxVal - ptPosLine3Pt2.y()));
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("P1", m_pPhysValLine3->p1().toQPointF());
    pTestStep->setConfigValue("P2", m_pPhysValLine3->p2().toQPointF());
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForLine(
        strGraphObjName, m_ptPosLine3, m_lineLine3, *m_pPhysValLine3, false));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 3 - Pt1
    //------------------------------

    strGraphObjKeyInTreeParent = pIdxTree->buildKeyInTreeStr(strEntryType, c_strGraphObjNameLine3);
    idxPt = 0;
    strGraphObjName = "CnctPoint-P" + QString::number(idxPt) + "-1";
    strMethod = c_strGraphObjNameLine3 + "." + "addConnectionPoint";
    strMthArgs = eSelPtTypePolygonPoint.toString() + ", " + QString::number(idxPt);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine3Pt1;
    physValCnctPt = m_pPhysValLine3->p1();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 3 - Pt2
    //------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine3Pt2;
    physValCnctPt = m_pPhysValLine3->p2();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 3 - LineCenter
    //-------------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = m_ptPosLine3;
    physValCnctPt = m_pPhysValLine3->center();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjLine(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strGraphObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strGraphObjName));
    QPointF ptPosLine4Pt1(575.0, 325.0);
    QPointF ptPosLine4Pt2(625.0, 375.0);
    m_ptPosLine4 = QPointF(600.0, 350.0);
    m_lineLine4 = QLineF(QPointF(-25.0, -25.0), QPointF(25.0, 25.0));
    m_pPhysValLine4->setP1(QPointF(ptPosLine4Pt1.x(), bYAxisTopDown ? ptPosLine4Pt1.y() : fYAxisMaxVal - ptPosLine4Pt1.y()));
    m_pPhysValLine4->setP2(QPointF(ptPosLine4Pt2.x(), bYAxisTopDown ? ptPosLine4Pt2.y() : fYAxisMaxVal - ptPosLine4Pt2.y()));
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("P1", m_pPhysValLine4->p1().toQPointF());
    pTestStep->setConfigValue("P2", m_pPhysValLine4->p2().toQPointF());
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForLine(
        strGraphObjName, m_ptPosLine4, m_lineLine4, *m_pPhysValLine4, false));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 4 - Pt1
    //------------------------------

    strGraphObjKeyInTreeParent = pIdxTree->buildKeyInTreeStr(strEntryType, c_strGraphObjNameLine4);
    idxPt = 0;
    strGraphObjName = "CnctPoint-P" + QString::number(idxPt) + "-1";
    strMethod = c_strGraphObjNameLine4 + "." + "addConnectionPoint";
    strMthArgs = eSelPtTypePolygonPoint.toString() + ", " + QString::number(idxPt);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine4Pt1;
    physValCnctPt = m_pPhysValLine4->p1();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 4 - Pt2
    //------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = ptPosLine4Pt2;
    physValCnctPt = m_pPhysValLine4->p2();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Line 4 - LineCenter
    //-------------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = m_ptPosLine4;
    physValCnctPt = m_pPhysValLine4->center();
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    *m_pPhysValPolygonConnectionLineLine1P2Line2P2 = QPolygonF({
        {QPointF(225.0, bYAxisTopDown ? 275.0 : fYAxisMaxVal - 275.0)},
        {QPointF(225.0, bYAxisTopDown ? 325.0 : fYAxisMaxVal - 325.0)}
    });
    ...
    pTestStep->setConfigValue("GraphObjKeyInTreeCnctPt2", strGraphObjKeyInTreeCnctPt2);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    *m_pPhysValPolygonConnectionLineLine2P1Line4P2 = QPolygonF({
        {QPointF(175.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0)},
        {QPointF(625.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0)}
    });
    ...
    *m_pPhysValPolygonConnectionLineLine4P1Line3P1 = QPolygonF({
        {QPointF(575.0, bYAxisTopDown ? 325.0 : fYAxisMaxVal - 325.0)},
        {QPointF(575.0, bYAxisTopDown ? 275.0 : fYAxisMaxVal - 275.0)}
    });
    strGraphObjCnctPt1Name = "CnctPoint-P0-1";
    ...
    // Connection Line: Line 4 - P1 -> Line 3 - P1: setLineEndStyle(EndPoint, Arrow)
    //------------------------------------------------------------------------------
    ...
    *m_pPhysValPolygonConnectionLineLine3P2Line1P1 = QPolygonF({
        {QPointF(625.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(175.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)}
    });
    strGraphObjCnctPt1Name = "CnctPoint-P1-1";
    ...
    // Connection Line: Line 3 - P2 -> Line 1 - P1: setLineEndStyle(EndPoint, Arrow)
    //------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesConnectionPointsAnchoredToLinesModifications(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesConnectionPointsAnchoredToLinesModifications",
        /* strAddInfo   */ strMthInArgs );
    ...
    strGraphObjName = c_strGraphObjNameLine1;
    strMethod = "setPosition";
    m_ptPosLine1 = QPointF(275.0, 200.0);
    strMthArgs = m_pPhysValLine1->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    QPointF ptLine1Pt1(250.0, bYAxisTopDown ? 175.0 : fYAxisMaxVal - 175.0);
    QPointF ptLine1Pt2(300.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0);
    m_lineLine1 = QLineF(QPointF(-25.0, -25.0), QPointF(25.0, 25.0));
    m_pPhysValLine1->setP1(ptLine1Pt1);
    m_pPhysValLine1->setP2(ptLine1Pt2);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValLine1->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameLine1]},
    ...
    strGraphObjCnctPt2Name = "CnctPoint-P1-1";
    m_polygonConnectionLineLine1P2Line2P2 = QPolygonF({
        { bUnitPixel ?  38.0 :  37.5, -50.0},
        { bUnitPixel ? -38.0 : -37.5,  50.0}
    });
    *m_pPhysValPolygonConnectionLineLine1P2Line2P2 = QPolygonF({
        {QPointF(300.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(225.0, bYAxisTopDown ? 325.0 : fYAxisMaxVal - 325.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    strGraphObjCnctPt2Name = "CnctPoint-P0-1";
    m_polygonConnectionLineLine3P2Line1P1 = QPolygonF({
        { bUnitPixel ?  188.0 :  187.5,  25.0},
        { bUnitPixel ? -188.0 : -187.5, -25.0}
    });
    *m_pPhysValPolygonConnectionLineLine3P2Line1P1 = QPolygonF({
        {QPointF(625.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(250.0, bYAxisTopDown ? 175.0 : fYAxisMaxVal - 175.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    strGraphObjName = c_strGraphObjNameLine2;
    strMethod = "setPosition";
    m_ptPosLine2 = QPointF(275.0, 400.0);
    strMthArgs = m_pPhysValLine2->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyCnctPts,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjLineByDirectMethodCalls(ZS::Test::CTestStep*)) );
    QPointF ptLine2Pt1(250.0, bYAxisTopDown ? 425.0 : fYAxisMaxVal - 425.0);
    QPointF ptLine2Pt2(300.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0);
    m_lineLine2 = QLineF(QPointF(-25.0, 25.0), QPointF(25.0, -25.0));
    m_pPhysValLine2->setP1(ptLine2Pt1);
    m_pPhysValLine2->setP2(ptLine2Pt2);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValLine2->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameLine2]},
        {m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineLine1Pt2Line2Pt2]},
    ...
    *m_pPhysValPolygonConnectionLineLine1P2Line2P2 = QPolygonF({
        {QPointF(300.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(300.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineLine1Pt2Line2Pt2,
        strGraphObjCnctPt1Name, strGraphObjCnctPt2Name,
    ...
    *m_pPhysValPolygonConnectionLineLine2P1Line4P2 = QPolygonF({
        {QPointF(250.0, bYAxisTopDown ? 425.0 : fYAxisMaxVal - 425.0)},
        {QPointF(625.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    strGraphObjName = c_strGraphObjNameLine3;
    strMethod = "setPosition";
    m_ptPosLine3 = QPointF(525.0, 200.0);
    strMthArgs = m_pPhysValLine3->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyCnctPts,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjLineByDirectMethodCalls(ZS::Test::CTestStep*)) );
    QPointF ptLine3Pt1(500.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0);
    QPointF ptLine3Pt2(550.0, bYAxisTopDown ? 175.0 : fYAxisMaxVal - 175.0);
    m_lineLine3 = QLineF(QPointF(-25.0, 25.0), QPointF(25.0, -25.0));
    m_pPhysValLine3->setP1(ptLine3Pt1);
    m_pPhysValLine3->setP2(ptLine3Pt2);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValLine3->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameLine3]},
        {m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineLine3Pt2Line1Pt1]},
    ...
    *m_pPhysValPolygonConnectionLineLine3P2Line1P1 = QPolygonF({
        {QPointF(550.0, bYAxisTopDown ? 175.0 : fYAxisMaxVal - 175.0)},
        {QPointF(250.0, bYAxisTopDown ? 175.0 : fYAxisMaxVal - 175.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineLine3Pt2Line1Pt1,
    ...
    *m_pPhysValPolygonConnectionLineLine4P1Line3P1 = QPolygonF({
        {QPointF(575.0, bYAxisTopDown ? 325.0 : fYAxisMaxVal - 325.0)},
        {QPointF(500.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    strGraphObjName = c_strGraphObjNameLine4;
    strMethod = "setPosition";
    m_ptPosLine4 = QPointF(525.0, 400.0);
    strMthArgs = m_pPhysValLine4->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyCnctPts,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjLineByDirectMethodCalls(ZS::Test::CTestStep*)) );
    QPointF ptLine4Pt1(500.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0);
    QPointF ptLine4Pt2(550.0, bYAxisTopDown ? 425.0 : fYAxisMaxVal - 425.0);
    m_lineLine4 = QLineF(QPointF(-25.0, -25.0), QPointF(25.0, 25.0));
    m_pPhysValLine4->setP1(ptLine4Pt1);
    m_pPhysValLine4->setP2(ptLine4Pt2);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValLine4->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameLine4]},
        {m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineLine2Pt1Line4Pt2]},
        {m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineLine4Pt1Line3Pt1]}});
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ...
    *m_pPhysValPolygonConnectionLineLine2P1Line4P2 = QPolygonF({
        {QPointF(250.0, bYAxisTopDown ? 425.0 : fYAxisMaxVal - 425.0)},
        {QPointF(550.0, bYAxisTopDown ? 425.0 : fYAxisMaxVal - 425.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineLine2Pt1Line4Pt2,
        strGraphObjCnctPt1Name, strGraphObjCnctPt2Name,
    ...
    *m_pPhysValPolygonConnectionLineLine4P1Line3P1 = QPolygonF({
        {QPointF(500.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0)},
        {QPointF(500.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineLine4Pt1Line3Pt1,
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesConnectionPointsAnchoredToRects(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesConnectionPointsAnchoredToRects",
        /* strAddInfo   */ strMthInArgs );
    ...
    QString strGraphObjCnctPt1Name;
    QString strGraphObjCnctPt2Name;
    CEnumSelectionPointType eSelPtType(ESelectionPointType::BoundingRectangle);
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjRect(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strGraphObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strGraphObjName));
    m_ptPosRect1 = QPointF(175.0, 250.0);
    QPointF ptCenterRect1(175.0, bYAxisTopDown ? 250.0 : fYAxisMaxVal - 250.0);
    ...
    // Connection Point Rectangle 1 - RightCenter
    //-------------------------------------------
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjConnectionPoint(ZS::Test::CTestStep*)) );
    pTestStep->setConfigValue("GraphObjKeyInTreeParent", strGraphObjKeyInTreeParent);
    pTestStep->setConfigValue("SelectionPointType", eSelPtType.toString());
    pTestStep->setConfigValue("SelectionPoint", eSelPt.toString());
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = getSelectionPointCoors(*m_pPhysValRect1, eSelPt.enumerator());
    physValCnctPt = QPointF(ptPosCnctPt.x(), bYAxisTopDown ? ptPosCnctPt.y() : fYAxisMaxVal - ptPosCnctPt.y());
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Rectangle 1 - BottomCenter
    //--------------------------------------------
    ...
    pTestStep = new ZS::Test::CTestStep(
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjRect(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strGraphObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strGraphObjName));
    m_ptPosRect2 = QPointF(175.0, 350.0);
    QPointF ptCenterRect2(175.0, bYAxisTopDown ? 350.0 : fYAxisMaxVal - 350.0);
    ...
    // Connection Point Rectangle 2 - RightCenter
    //-------------------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = getSelectionPointCoors(*m_pPhysValRect2, eSelPt.enumerator());
    physValCnctPt = QPointF(ptPosCnctPt.x(), bYAxisTopDown ? ptPosCnctPt.y() : fYAxisMaxVal - ptPosCnctPt.y());
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Rectangle 2 - TopCenter
    //-------------------------------------------
    ...
    QPointF ptCenterRect3(600.0, bYAxisTopDown ? 250.0 : fYAxisMaxVal - 250.0);
    ...
    // Connection Point Rectangle 3 - LeftCenter
    //-------------------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = getSelectionPointCoors(*m_pPhysValRect3, eSelPt.enumerator());
    physValCnctPt = QPointF(ptPosCnctPt.x(), bYAxisTopDown ? ptPosCnctPt.y() : fYAxisMaxVal - ptPosCnctPt.y());
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Rectangle 3 - BottomCenter
    //-------------------------------------------
    ...
    QPointF ptCenterRect4(600.0, bYAxisTopDown ? 350.0 : fYAxisMaxVal - 350.0);
    ...
    // Connection Point Rectangle 4 - LeftCenter
    //-------------------------------------------
    ...
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ptPosCnctPt = getSelectionPointCoors(*m_pPhysValRect4, eSelPt.enumerator());
    physValCnctPt = QPointF(ptPosCnctPt.x(), bYAxisTopDown ? ptPosCnctPt.y() : fYAxisMaxVal - ptPosCnctPt.y());
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        strGraphObjName, ptPosCnctPt, physValCnctPt, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Connection Point Rectangle 4 - TopCenter
    //-------------------------------------------
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesConnectionPointsAnchoredToRectsModifications(
    ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesConnectionPointsAnchoredToRectsModifications",
        /* strAddInfo   */ strMthInArgs );
    ...
    strGraphObjName = c_strGraphObjNameRect1;
    strMethod = "setPosition";
    m_ptPosRect1 = QPointF(275.0, 200.0);
    m_pPhysValRect1->setCenter(QPointF(275.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0));
    strMthArgs = m_pPhysValRect1->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValRect1->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameRect1]},
    ...
    *m_pPhysValPolygonConnectionLineRect1BottomCenterRect2TopCenter = QPolygonF({
        {QPointF(275.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(175.0, bYAxisTopDown ? 325.0 : fYAxisMaxVal - 325.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    *m_pPhysValPolygonConnectionLineRect1RightCenterRect4LeftCenter = QPolygonF({
        {QPointF(300.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0)},
        {QPointF(575.0, bYAxisTopDown ? 350.0 : fYAxisMaxVal - 350.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    strGraphObjName = c_strGraphObjNameRect2;
    strMethod = "setPosition";
    m_ptPosRect2 = QPointF(275.0, 400.0);
    m_pPhysValRect2->setCenter(QPointF(275.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0));
    strMthArgs = m_pPhysValRect2->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValRect2->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameRect2]},
        {m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineRect1BottomCenterRect2TopCenter]},
    ...
    *m_pPhysValPolygonConnectionLineRect1BottomCenterRect2TopCenter = QPolygonF({
        {QPointF(275.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(275.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineRect1BottomCenterRect2TopCenter,
        strGraphObjCnctPt1Name, strGraphObjCnctPt2Name,
    ...
    *m_pPhysValPolygonConnectionLineRect3LeftCenterRect2RightCenter = QPolygonF({
        {QPointF(575.0, bYAxisTopDown ? 250.0 : fYAxisMaxVal - 250.0)},
        {QPointF(300.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    strGraphObjName = c_strGraphObjNameRect3;
    strMethod = "setPosition";
    m_ptPosRect3 = QPointF(525.0, 200.0);
    m_pPhysValRect3->setCenter(QPointF(525.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0));
    strMthArgs = m_pPhysValRect3->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValRect3->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameRect3]},
    ...
    *m_pPhysValPolygonConnectionLineRect3BottomCenterRect4TopCenter = QPolygonF({
        {QPointF(525.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(600.0, bYAxisTopDown ? 325.0 : fYAxisMaxVal - 325.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
    ...
    *m_pPhysValPolygonConnectionLineRect3LeftCenterRect2RightCenter = QPolygonF({
        {QPointF(500.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0)},
        {QPointF(300.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineRect3LeftCenterRect2RightCenter,
    ...
    strGraphObjName = c_strGraphObjNameRect4;
    strMethod = "setPosition";
    m_ptPosRect4 = QPointF(525.0, 400.0);
    m_pPhysValRect4->setCenter(QPointF(525.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0));
    strMthArgs = m_pPhysValRect4->toString(true);
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strGraphObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("Pos", m_pPhysValRect4->center().toQPointF());
    pTestStep->setConfigValue("Pos.unit", strUnit);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", QStringList{
        {m_hshGraphObjNameToKeys[c_strGraphObjNameRect4]},
        {m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineRect1RightCenterRect4LeftCenter]},
        {m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineRect3BottomCenterRect4TopCenter]}});
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    ...
    *m_pPhysValPolygonConnectionLineRect1RightCenterRect4LeftCenter = QPolygonF({
        {QPointF(300.0, bYAxisTopDown ? 200.0 : fYAxisMaxVal - 200.0)},
        {QPointF(500.0, bYAxisTopDown ? 400.0 : fYAxisMaxVal - 400.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineRect1RightCenterRect4LeftCenter,
        strGraphObjCnctPt1Name, strGraphObjCnctPt2Name,
    ...
    *m_pPhysValPolygonConnectionLineRect3BottomCenterRect4TopCenter = QPolygonF({
        {QPointF(525.0, bYAxisTopDown ? 225.0 : fYAxisMaxVal - 225.0)},
        {QPointF(525.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0)}
    });
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineRect3BottomCenterRect4TopCenter,
        strGraphObjCnctPt1Name, strGraphObjCnctPt2Name,
    ...
    // CnctLineRect1BottomCenterRect2TopCenter.insert(1, )
    //----------------------------------------------------

    idxPt = 1;
    physValPoint.setX(240.0);
    physValPoint.setY(bYAxisTopDown ? 250.0 : fYAxisMaxVal - 250.0);
    strGraphObjType = graphObjType2Str(EGraphObjTypeConnectionLine);
    strGraphObjName = c_strGraphObjNameConnectionLineRect1BottomCenterRect2TopCenter;
    strMethod = "insert";
    ...
    m_pPhysValPolygonConnectionLineRect1BottomCenterRect2TopCenter->insert(idxPt, physValPoint);
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GraphObjName", strGraphObjName);
    pTestStep->setConfigValue("GraphObjKeyInTree", m_hshGraphObjNameToKeys[strGraphObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    ...
    // CnctLineRect1BottomCenterRect2TopCenter.insert(2, )
    //----------------------------------------------------
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesSmallPlusSign(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesSmallPlusSign",
        /* strAddInfo   */ strMthInArgs );
    ...
    *m_pPhysValRectSmallPlusSign = CPhysValRect(*m_pDrawingScene, ptTLSmallPlusSign, m_sizeSmallPlusSign);
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameSmallPlusSign, m_ptPosSmallPlusSign, *m_pPhysValRectSmallPlusSign, false));
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesSmallPlusSignResize(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesSmallPlusSignResize",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesBigPlusSign(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesBigPlusSign",
        /* strAddInfo   */ strMthInArgs );
    ...
    *m_pPhysValRectBigPlusSign = CPhysValRect(*m_pDrawingScene, ptTLBigPlusSign, m_sizeBigPlusSign);
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameBigPlusSign, m_ptPosBigPlusSign, *m_pPhysValRectBigPlusSign, false));
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesBigPlusSignRotateParent(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesBigPlusSignRotateParent",
        /* strAddInfo   */ strMthInArgs );
    ...
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameTopGroup, m_ptPosTopGroup, *m_pPhysValRectTopGroup, false));
    // BigPlusSign
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesBigPlusSignModfications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesBigPlusSignModfications",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesPlusSigns(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesPlusSignsModifications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(+
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesPlusSignsModifications",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesCheckmark(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesCheckmark",
        /* strAddInfo   */ strMthInArgs );
    ...
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameCheckmark, m_ptPosCheckmark, *m_pPhysValRectCheckmark, false));
    // Checkmark-LeftLine
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupLinesCheckmarkModifications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupLinesCheckmarkModifications",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupRectsCrosses(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupRectsCrosses",
        /* strAddInfo   */ strMthInArgs );
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForRect(
        strObjName, m_ptPosRectBigCrossVerticalBar, m_rectRectBigCrossVerticalBar, *m_pPhysValRectBigCrossVerticalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForRect(
        strObjName, m_ptPosRectBigCrossHorizontalBar, m_rectRectBigCrossHorizontalBar, *m_pPhysValRectBigCrossHorizontalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Group BigCross
    //---------------

    strObjName = c_strGraphObjNameBigCross;
    strMthArgs = strObjName;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjGroup(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strObjName));
    m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameBigCrossVerticalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossHorizontalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameBigCrossHorizontalBar);
    strlstGraphObjsAddToGroup.clear();
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameBigCrossVerticalBar);
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameBigCrossHorizontalBar);
    ...
    strlstExpectedValues.append(resultValuesForGroup(strObjName, m_ptPosBigCross, *m_pPhysValRectBigCross, false));
    // BigCross-VerticalBar
    ...
    strlstExpectedValues.append(resultValuesForRect(
        ...
        m_rectRectBigCrossVerticalBar, *m_pPhysValRectBigCrossVerticalBar, false));
    // BigCross-HorizontalBar
    ...
    strlstExpectedValues.append(resultValuesForRect(
        ...
        m_rectRectBigCrossHorizontalBar, *m_pPhysValRectBigCrossHorizontalBar, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForRect(
        strObjName, m_ptPosRectSmallCross1VerticalBar, m_rectRectSmallCross1VerticalBar, *m_pPhysValRectSmallCross1VerticalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForRect(
        strObjName, m_ptPosRectSmallCross1HorizontalBar, m_rectRectSmallCross1HorizontalBar, *m_pPhysValRectSmallCross1HorizontalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Group SmallCross1
    //------------------

    strObjName = c_strGraphObjNameSmallCross1;
    strMthArgs = strObjName;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjGroup(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strObjName));
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1VerticalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross1VerticalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1HorizontalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross1HorizontalBar);
    strlstGraphObjsAddToGroup.clear();
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameSmallCross1VerticalBar);
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameSmallCross1HorizontalBar);
    pTestStep->setConfigValue("GraphObjType", graphObjType2Str(EGraphObjTypeGroup));
    pTestStep->setConfigValue("GroupName", strObjName);
    pTestStep->setConfigValue("AddToGroup", strlstGraphObjsAddToGroup);
    strlstExpectedValues.clear();
    ...
    strlstExpectedValues.append(resultValuesForGroup(strObjName, m_ptPosSmallCross1, *m_pPhysValRectSmallCross1, false));
    // SmallCross1-VerticalBar
    ...
    strlstExpectedValues.append(resultValuesForRect(
        ...
        m_rectRectSmallCross1VerticalBar, *m_pPhysValRectSmallCross1VerticalBar, false));
    // SmallCross1-HorizontalBar
    ...
    strlstExpectedValues.append(resultValuesForRect(
        ...
        m_rectRectSmallCross1HorizontalBar, *m_pPhysValRectSmallCross1HorizontalBar, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForRect(
        strObjName, m_ptPosRectSmallCross2VerticalBar, m_rectRectSmallCross2VerticalBar, *m_pPhysValRectSmallCross2VerticalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForRect(
        strObjName, m_ptPosRectSmallCross2HorizontalBar, m_rectRectSmallCross2HorizontalBar, *m_pPhysValRectSmallCross2HorizontalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Group SmallCross2
    //------------------

    strObjName = c_strGraphObjNameSmallCross2;
    strMthArgs = strObjName;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjGroup(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strObjName));
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2VerticalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross2VerticalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2HorizontalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross2HorizontalBar);
    strlstGraphObjsAddToGroup.clear();
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameSmallCross2VerticalBar);
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameSmallCross2HorizontalBar);
    pTestStep->setConfigValue("GraphObjType", graphObjType2Str(EGraphObjTypeGroup));
    pTestStep->setConfigValue("GroupName", strObjName);
    ...
    strlstExpectedValues.append(resultValuesForGroup(strObjName, m_ptPosSmallCross2, *m_pPhysValRectSmallCross2, false));
    // SmallCross2-VerticalBar
    ...
    strlstExpectedValues.append(resultValuesForRect(
        ...
        m_rectRectSmallCross2VerticalBar, *m_pPhysValRectSmallCross2VerticalBar, false));
    // SmallCross2-HorizontalBar
    ...
    strlstExpectedValues.append(resultValuesForRect(
        ...
        m_rectRectSmallCross2HorizontalBar, *m_pPhysValRectSmallCross2HorizontalBar, false));
    pTestStep->setExpectedValues(strlstExpectedValues);
}

//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupRectsCrossesModifications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupRectsCrossesModifications",
        /* strAddInfo   */ strMthInArgs );
    ...
    ZS::Test::CTestStepGroup* pGrpModifyGroupCrosses = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Modify " + c_strGraphObjNameCrosses,
        /* pTSGrpParent */ i_pTestStepGroupParent );

    // Resize BigCross (setBottomRight)
    //---------------------------------

    QPointF ptBRGroupBigCross(450.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0);
    strObjName = c_strGraphObjNameBigCross;
    strMethod = "setBottomRight";
    strMthArgs = qPoint2Str(ptBRGroupBigCross) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* pGrpParent      */ pGrpModifyGroupCrosses,
        /* szDoTestStepFct */ SLOT(doTestStepModifyGraphObjGroupByDirectMethodCalls(ZS::Test::CTestStep*)) );
    iResultValuesPrecision = 6;
    pTestStep->setConfigValue("GraphObjType", strGraphObjType);
    pTestStep->setConfigValue("GroupName", strObjName);
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("BottomRight", ptBRGroupBigCross);
    ...
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossHorizontalBar]);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", strlstGraphObjsKeyInTreeGetResultValues);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    // Group BigCross
    m_ptPosBigCross = QPointF(375.0, 287.5);
    m_sizeBigCross = QSizeF(150.0, 175.0);
    m_pPhysValRectBigCross->setSize(m_sizeBigCross);
    m_pPhysValRectBigCross->setCenter(QPointF(m_ptPosBigCross.x(), bYAxisTopDown ? m_ptPosBigCross.y() : fYAxisMaxVal - m_ptPosBigCross.y()));
    strlstExpectedValues.append(resultValuesForGroup(strObjName, m_ptPosBigCross, *m_pPhysValRectBigCross, false, iResultValuesPrecision));
    // BigCross-VerticalBar
    m_ptPosRectBigCrossVerticalBar = QPointF(0.0, 0.0);
    ...
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameBigCrossVerticalBar, m_ptPosRectBigCrossVerticalBar,
        m_rectRectBigCrossVerticalBar, *m_pPhysValRectBigCrossVerticalBar, false, iResultValuesPrecision));
    // BigCross-HorizontalBar
    ...
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameBigCrossHorizontalBar, m_ptPosRectBigCrossHorizontalBar,
        m_rectRectBigCrossHorizontalBar, *m_pPhysValRectBigCrossHorizontalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Resize BigCross (setBottomLeft)
    //---------------------------------

    QPointF ptBLGroupBigCross(350.0, bYAxisTopDown ? 375.0 : fYAxisMaxVal - 375.0);
    strObjName = c_strGraphObjNameBigCross;
    strMethod = "setBottomLeft";
    strMthArgs = qPoint2Str(ptBLGroupBigCross) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("BottomLeft", ptBLGroupBigCross);
    pTestStep->setConfigValue("BottomLeft.unit", strUnit);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[strObjName]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossHorizontalBar]);
    ...
    strlstExpectedValues.clear();
    // Group BigCross
    m_ptPosBigCross = QPointF(400.0, 287.5);
    m_sizeBigCross = QSizeF(100.0, 175.0);
    m_pPhysValRectBigCross->setSize(m_sizeBigCross);
    m_pPhysValRectBigCross->setCenter(QPointF(400.0, bYAxisTopDown ? 287.5 : fYAxisMaxVal - 287.5));
    strlstExpectedValues.append(resultValuesForGroup(strObjName, m_ptPosBigCross, *m_pPhysValRectBigCross, false, iResultValuesPrecision));
    // BigCross-VerticalBar
    m_ptPosRectBigCrossVerticalBar = QPointF(0.0, 0.0);
    ...
    // Resize BigCross (setHeightByMovingTopCenter)
    //---------------------------------------------

    QPointF ptTCGroupBigCross(400.0, bYAxisTopDown ? 275.0 : fYAxisMaxVal - 275.0);
    strObjName = c_strGraphObjNameBigCross;
    strMethod = "setHeightByMovingTopCenter";
    strMthArgs = qPoint2Str(ptTCGroupBigCross) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("TopCenter", ptTCGroupBigCross);
    pTestStep->setConfigValue("TopCenter.unit", strUnit);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[strObjName]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossHorizontalBar]);
    ...
    strlstExpectedValues.clear();
    // Group BigCross
    m_ptPosBigCross = QPointF(400.0, 325.0);
    m_sizeBigCross = QSizeF(100.0, 100.0);
    m_pPhysValRectBigCross->setSize(m_sizeBigCross);
    m_pPhysValRectBigCross->setCenter(QPointF(400.0, bYAxisTopDown ? 325.0 : fYAxisMaxVal - 325.0));
    strlstExpectedValues.append(resultValuesForGroup(strObjName, m_ptPosBigCross, *m_pPhysValRectBigCross, false, iResultValuesPrecision));
    // BigCross-VerticalBar
    m_ptPosRectBigCrossVerticalBar = QPointF(0.0, 0.0);
    ...
    m_physValAngleSmallCross1.setVal(-30.0);
    strObjName = c_strGraphObjNameSmallCross1;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleSmallCross1.toString();
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", "setRotationAngle");
    pTestStep->setConfigValue("Angle", m_physValAngleSmallCross1.toString());
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    // Group SmallCross1
    m_pPhysValRectSmallCross1->setAngle(m_physValAngleSmallCross1);
    strlstExpectedValues.append(resultValuesForGroup(strObjName, m_ptPosSmallCross1, *m_pPhysValRectSmallCross1, false, iResultValuesPrecision));
    // SmallCross1-VerticalBar
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameSmallCross1VerticalBar, m_ptPosRectSmallCross1VerticalBar,
        m_rectRectSmallCross1VerticalBar, *m_pPhysValRectSmallCross1VerticalBar, false, iResultValuesPrecision));
    // SmallCross1-HorizontalBar
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameSmallCross1HorizontalBar, m_ptPosRectSmallCross1HorizontalBar,
        m_rectRectSmallCross1HorizontalBar, *m_pPhysValRectSmallCross1HorizontalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Resize SmallCross1 (setTopRight)
    //------------------------------------

    QPointF ptTRGroupSmallCross1(279.0, bYAxisTopDown ? 274.0 : fYAxisMaxVal - 274.0);
    strObjName = c_strGraphObjNameSmallCross1;
    strMethod = "setTopRight";
    strMthArgs = qPoint2Str(ptTRGroupSmallCross1) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("TopRight", ptTRGroupSmallCross1);
    pTestStep->setConfigValue("TopRight.unit", strUnit);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[strObjName]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1VerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1HorizontalBar]);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", strlstGraphObjsKeyInTreeGetResultValues);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    // Group SmallCross1
    ...
    m_physValAngleSmallCross2.setVal(30.0);
    strObjName = c_strGraphObjNameSmallCross2;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleSmallCross2.toString();
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", "setRotationAngle");
    pTestStep->setConfigValue("Angle", m_physValAngleSmallCross2.toString());
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    // Group SmallCross2
    ...
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameSmallCross2VerticalBar, m_ptPosRectSmallCross2VerticalBar,
        m_rectRectSmallCross2VerticalBar, *m_pPhysValRectSmallCross2VerticalBar, false, iResultValuesPrecision));
    // SmallCross2-HorizontalBar
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameSmallCross2HorizontalBar, m_ptPosRectSmallCross2HorizontalBar,
        m_rectRectSmallCross2HorizontalBar, *m_pPhysValRectSmallCross2HorizontalBar, false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);

    // Resize SmallCross2 (setTopLeft)
    //------------------------------------

    QPointF ptTLGroupSmallCross2(522.0, bYAxisTopDown ? 272.0 : fYAxisMaxVal - 272.0);
    strObjName = c_strGraphObjNameSmallCross2;
    strMethod = "setTopLeft";
    strMthArgs = qPoint2Str(ptTLGroupSmallCross2) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("TopLeft", ptTLGroupSmallCross2);
    pTestStep->setConfigValue("TopLeft.unit", strUnit);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[strObjName]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2VerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2HorizontalBar]);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", strlstGraphObjsKeyInTreeGetResultValues);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    // Group SmallCross2
    ...
    // Create TopGroup Crosses
    //------------------------

    strMethod = "DrawingScene.addGraphObj";
    strObjName = c_strGraphObjNameCrosses;
    strMthArgs = strObjName;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strMethod + "(" + strMthArgs + ")",
        ...
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjGroup(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(strObjName, pIdxTree->buildKeyInTreeStr(strEntryType, strObjName));
    m_hshGraphObjNameToKeys[c_strGraphObjNameBigCross] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameBigCross);
    m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameBigCross, c_strGraphObjNameBigCrossVerticalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossHorizontalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameBigCross, c_strGraphObjNameBigCrossHorizontalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross1);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1VerticalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross1, c_strGraphObjNameSmallCross1VerticalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1HorizontalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross1, c_strGraphObjNameSmallCross1HorizontalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross2);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2VerticalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross2, c_strGraphObjNameSmallCross2VerticalBar);
    m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2HorizontalBar] = pIdxTree->buildKeyInTreeStr(
        strEntryType, strObjName, c_strGraphObjNameSmallCross2, c_strGraphObjNameSmallCross2HorizontalBar);
    strlstGraphObjsAddToGroup.clear();
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameBigCross);
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameSmallCross1);
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameSmallCross2);
    pTestStep->setConfigValue("GraphObjType", graphObjType2Str(EGraphObjTypeGroup));
    pTestStep->setConfigValue("GroupName", strObjName);
    pTestStep->setConfigValue("AddToGroup", strlstGraphObjsAddToGroup);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[strObjName]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCross]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossHorizontalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1VerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross1HorizontalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2VerticalBar]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameSmallCross2HorizontalBar]);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", strlstGraphObjsKeyInTreeGetResultValues);
    strlstExpectedValues.clear();
    ...
    strlstExpectedValues.append(resultValuesForGroup(
        strObjName, m_ptPosCrosses, *m_pPhysValRectCrosses, false, iResultValuesPrecision));
    // Group BigCross
    m_ptPosBigCross = QPointF(-0.6, -15.6);
    m_pPhysValRectBigCross->setCenter(QPointF(208.134918, bYAxisTopDown ? 53.000000 : 84.150635));
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameBigCross, m_ptPosBigCross, *m_pPhysValRectBigCross, false, iResultValuesPrecision));
    // BigCross-VerticalBar
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameBigCrossVerticalBar, m_ptPosRectBigCrossVerticalBar,
        m_rectRectBigCrossVerticalBar, *m_pPhysValRectBigCrossVerticalBar, false, iResultValuesPrecision));
    ...
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameSmallCross1, m_ptPosSmallCross1, *m_pPhysValRectSmallCross1, false, iResultValuesPrecision));
    // SmallCross1-VerticalBar
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameSmallCross1VerticalBar, m_ptPosRectSmallCross1VerticalBar,
        m_rectRectSmallCross1VerticalBar, *m_pPhysValRectSmallCross1VerticalBar, false, iResultValuesPrecision));
    ...
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameSmallCross2, m_ptPosSmallCross2, *m_pPhysValRectSmallCross2, false, iResultValuesPrecision));
    // SmallCross2-VerticalBar
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameSmallCross2VerticalBar, m_ptPosRectSmallCross2VerticalBar,
        m_rectRectSmallCross2VerticalBar, *m_pPhysValRectSmallCross2VerticalBar, false, iResultValuesPrecision));
    ...
    // Resize Crosses (setWidthByMovingLeftCenter)
    //--------------------------------------------

    QPointF ptLCGroupBigCross(250.0, bYAxisTopDown ? 350.0 : fYAxisMaxVal - 350.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setWidthByMovingLeftCenter";
    strMthArgs = qPoint2Str(ptLCGroupBigCross) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("LeftCenter", ptLCGroupBigCross);
    pTestStep->setConfigValue("LeftCenter.unit", strUnit);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[strObjName]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCross]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar]);
    ...
    // Resize Crosses (setWidthByMovingRightCenter)
    //---------------------------------------------

    QPointF ptRCGroupBigCross(550.0, bYAxisTopDown ? 350.0 : fYAxisMaxVal - 350.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setWidthByMovingRightCenter";
    strMthArgs = qPoint2Str(ptRCGroupBigCross) + " " + strUnit;
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", strMethod);
    pTestStep->setConfigValue("RightCenter", ptRCGroupBigCross);
    pTestStep->setConfigValue("RightCenter.unit", strUnit);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[strObjName]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCross]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameBigCrossVerticalBar]);
    ...
    // Rotate TopGroup Crosses
    //------------------------

    m_physValAngleCrosses.setVal(45.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleCrosses.toString();
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + strObjName + "." + strMethod + "(" + strMthArgs + ")",
        /* strOperation    */ strObjName + "." + strMethod + "(" + strMthArgs + ")",
    ...
    pTestStep->setConfigValue("GroupKeyInTree", m_hshGraphObjNameToKeys[strObjName]);
    pTestStep->setConfigValue("Method", "setRotationAngle");
    pTestStep->setConfigValue("Angle", m_physValAngleCrosses.toString());
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    // TopGroup Crosses
    m_pPhysValRectCrosses->setAngle(m_physValAngleCrosses);
    strlstExpectedValues.append(resultValuesForGroup(
        strObjName, m_ptPosCrosses, *m_pPhysValRectCrosses, false, iResultValuesPrecision));
    // Group BigCross
    strlstExpectedValues.append(resultValuesForGroup(
    ...
    m_physValAngleCrosses.setVal(90.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleCrosses.toString();
    pTestStep = new ZS::Test::CTestStep(
    ...
    m_physValAngleCrosses.setVal(135.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleCrosses.toString();
    pTestStep = new ZS::Test::CTestStep(
    ...
    m_physValAngleCrosses.setVal(180.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleCrosses.toString();
    pTestStep = new ZS::Test::CTestStep(
    ...
    m_physValAngleCrosses.setVal(270.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleCrosses.toString();
    pTestStep = new ZS::Test::CTestStep(
    ...
    m_physValAngleCrosses.setVal(360.0);
    strObjName = c_strGraphObjNameCrosses;
    strMethod = "setRotationAngle";
    strMthArgs = m_physValAngleCrosses.toString();
    pTestStep = new ZS::Test::CTestStep(
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupEllipsesCrosses(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupEllipsesCrosses",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupEllipsesCrossesModifications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupEllipsesCrossesModifications",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupTextsCrosses(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupTextsCrosses",
        /* strAddInfo   */ strMthInArgs );
    ...
    strlstExpectedValues.clear();
    strlstExpectedValues.append(resultValuesForText(
        strObjName, m_ptPosRectBigCrossVerticalBar,
        *m_pPhysValRectBigCrossVerticalBar, strText,
        false, iResultValuesPrecision));
    pTestStep->setExpectedValues(strlstExpectedValues);
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupTextsCrossesModifications(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupTextsCrossesModifications",
        /* strAddInfo   */ strMthInArgs );
...
//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupConnectionPointsNotAnchored(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupConnectionPointsNotAnchored",
        /* strAddInfo   */ strMthInArgs );
    ...
    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPointsAddConnectionPointsNotAnchored = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Add NotAnchored ConnectionPoints",
        /* pTSGrpParent */ i_pTestStepGroupParent );
    createTestGroupAddStandardShapesConnectionPointsNotAnchored(pGrpGroupsConnectionPointsAddConnectionPointsNotAnchored);

    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPointsModifyConnectionPointsNotAnchored = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Modify NotAnchored ConnectionPoints",
        /* pTSGrpParent */ i_pTestStepGroupParent );
    createTestGroupAddStandardShapesConnectionPointsNotAnchoredModifications(pGrpGroupsConnectionPointsModifyConnectionPointsNotAnchored);

    ZS::Test::CTestStepGroup* pGrpGroupsConnectionLinesAddGroups = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
    ...
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " Add(" + c_strGraphObjNameGroupConnectionPointsPt1Pt2 + ")",
        /* strOperation    */ "DrawingScene.addGraphObj(" + strFactoryGroupName + ", " + strGraphObjTypeGroup + ", " + c_strGraphObjNameGroupConnectionPointsPt1Pt2 + ")",
        /* pGrpParent      */ pGrpGroupsConnectionLinesAddGroups,
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjGroup(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(c_strGraphObjNameGroupConnectionPointsPt1Pt2, pIdxTree->buildKeyInTreeStr(strEntryType, c_strGraphObjNameGroupConnectionPointsPt1Pt2));
    m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionPoint1] = pIdxTree->buildKeyInTreeStr(
        strEntryType, c_strGraphObjNameGroupConnectionPointsPt1Pt2, c_strGraphObjNameConnectionPoint1);
    m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionPoint2] = pIdxTree->buildKeyInTreeStr(
        strEntryType, c_strGraphObjNameGroupConnectionPointsPt1Pt2, c_strGraphObjNameConnectionPoint2);
    iResultValuesPrecision = 3;
    strlstGraphObjsAddToGroup.clear();
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameConnectionPoint1);
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameConnectionPoint2);
    pTestStep->setConfigValue("GroupName", c_strGraphObjNameGroupConnectionPointsPt1Pt2);
    pTestStep->setConfigValue("AddToGroup", strlstGraphObjsAddToGroup);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameGroupConnectionPointsPt1Pt2]);
    ...
    strlstExpectedValues.clear();
    // Group
    m_ptPosConnectionPoints = QPointF(300.0, 300.0);
    m_sizeConnectionPoints = QSizeF(7.0, 207.0);
    m_pPhysValRectConnectionPoints->setSize(m_sizeConnectionPoints);
    m_pPhysValRectConnectionPoints->setCenter(QPointF(300.0, bYAxisTopDown ? 300.0 : fYAxisMaxVal - 300.0));
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameGroupConnectionPointsPt1Pt2, m_ptPosConnectionPoints, *m_pPhysValRectConnectionPoints, false, iResultValuesPrecision));
    // ConnectionPoint1
    m_ptPosConnectionPoint1 = QPointF(0.0, -100.0);
    *m_pPhysValConnectionPoint1 = QPointF(3.5, bYAxisTopDown ? 3.5 : 203.5);
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        c_strGraphObjNameConnectionPoint1, m_ptPosConnectionPoint1, *m_pPhysValConnectionPoint1, false, iResultValuesPrecision));
    // ConnectionPoint2
    m_ptPosConnectionPoint2 = QPointF(0.0, 100.0);
    *m_pPhysValConnectionPoint2 = QPointF(3.5, bYAxisTopDown ? 203.5 : 3.5);
    strlstExpectedValues.append(resultValuesForConnectionPoint(
        c_strGraphObjNameConnectionPoint2, m_ptPosConnectionPoint2, *m_pPhysValConnectionPoint2, false, iResultValuesPrecision));
    // ConnectionLine
    strlstExpectedValues.append(resultValuesForConnectionLine(
        c_strGraphObjNameConnectionLineCnctPt1CnctPt2, c_strGraphObjNameConnectionPoint1, c_strGraphObjNameConnectionPoint2,
        m_polygonConnectionLineCnctPt1CnctPt2, *m_pPhysValPolygonConnectionLineCnctPt1CnctPt2, false, iResultValuesPrecision));
    ...
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + c_strGraphObjNameGroupConnectionPointsPt1Pt2 + ".showLabel(" + CGraphObj::c_strLabelName + ")",
        /* strOperation    */ c_strGraphObjNameGroupConnectionPointsPt1Pt2 + ".showLabel(" + CGraphObj::c_strLabelName + ")",
        /* pGrpParent      */ pGrpGroupsConnectionLinesAddGroups,
        /* szDoTestStepFct */ SLOT(doTestStepShowLabels(ZS::Test::CTestStep*)) );
    pTestStep->addDataRow({
        {"GraphObjName", c_strGraphObjNameGroupConnectionPointsPt1Pt2},
        {"GraphObjKeyInTree", m_hshGraphObjNameToKeys[c_strGraphObjNameGroupConnectionPointsPt1Pt2]},
        {"LabelName", CGraphObj::c_strLabelName},
        {"AnchorPoint", SGraphObjSelectionPoint(nullptr, ESelectionPointType::BoundingRectangle, ESelectionPoint::TopCenter).toString()},
        {"setPos", QPointF(220.0, 300.0)},
        {"ExpectedText", c_strGraphObjNameGroupConnectionPointsPt1Pt2}
    });
}

//------------------------------------------------------------------------------
void CTest::createTestGroupAddStandardShapesGroupConnectionPointsAnchored(ZS::Test::CTestStepGroup* i_pTestStepGroupParent)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObjDrawTestSteps, EMethodTraceDetailLevel::ArgsNormal)) {
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObjDrawTestSteps,
        /* iDetailLevel */ EMethodTraceDetailLevel::EnterLeave,
        /* strMethod    */ "createTestGroupAddStandardShapesGroupConnectionPointsAnchored",
        /* strAddInfo   */ strMthInArgs );
    ...
    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPointsAddConnectionPointsAnchored = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Add Anchored ConnectionPoints",
        /* pTSGrpParent */ i_pTestStepGroupParent );
    createTestGroupAddStandardShapesConnectionPointsAnchoredToRects(pGrpGroupsConnectionPointsAddConnectionPointsAnchored);

    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPointsModifyConnectionPointsAnchored = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Modify Anchored ConnectionPoints",
        /* pTSGrpParent */ i_pTestStepGroupParent );
    createTestGroupAddStandardShapesConnectionPointsAnchoredToRectsModifications(pGrpGroupsConnectionPointsModifyConnectionPointsAnchored);

    ZS::Test::CTestStepGroup* pGrpGroupsConnectionPointsAddGroups = new ZS::Test::CTestStepGroup(
        /* pTest        */ this,
        /* strName      */ "Group " + QString::number(ZS::Test::CTestStepGroup::testGroupCount()) + " Add Groups",
        /* pTSGrpParent */ i_pTestStepGroupParent );
    ...
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " Add(" + c_strGraphObjNameGroupRect1Rect2 + ")",
        /* strOperation    */ "DrawingScene.addGraphObj(" + strFactoryGroupName + ", " + strGraphObjTypeGroup + ", " + c_strGraphObjNameGroupRect1Rect2 + ")",
        /* pGrpParent      */ pGrpGroupsConnectionPointsAddGroups,
        /* szDoTestStepFct */ SLOT(doTestStepAddGraphObjGroup(ZS::Test::CTestStep*)) );
    m_hshGraphObjNameToKeys.insert(c_strGraphObjNameGroupRect1Rect2, pIdxTree->buildKeyInTreeStr(strEntryType, c_strGraphObjNameGroupRect1Rect2));
    m_hshGraphObjNameToKeys[c_strGraphObjNameRect1] = pIdxTree->buildKeyInTreeStr(
        strEntryType, c_strGraphObjNameGroupRect1Rect2, c_strGraphObjNameRect1);
    m_hshGraphObjNameToKeys[c_strGraphObjNameRect2] = pIdxTree->buildKeyInTreeStr(
        strEntryType, c_strGraphObjNameGroupRect1Rect2, c_strGraphObjNameRect2);
    iResultValuesPrecision = 3;
    strlstGraphObjsAddToGroup.clear();
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameRect1);
    strlstGraphObjsAddToGroup.append(c_strGraphObjNameRect2);
    pTestStep->setConfigValue("GroupName", c_strGraphObjNameGroupRect1Rect2);
    pTestStep->setConfigValue("AddToGroup", strlstGraphObjsAddToGroup);
    strlstGraphObjsKeyInTreeGetResultValues.clear();
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameGroupRect1Rect2]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameRect1]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameRect2]);
    strlstGraphObjsKeyInTreeGetResultValues.append(m_hshGraphObjNameToKeys[c_strGraphObjNameConnectionLineRect1BottomCenterRect2TopCenter]);
    pTestStep->setConfigValue("GraphObjsKeyInTreeGetResultValues", strlstGraphObjsKeyInTreeGetResultValues);
    pTestStep->setConfigValue("ResultValuesPrecision", iResultValuesPrecision);
    strlstExpectedValues.clear();
    // Group
    m_ptPosRect1Rect2 = QPointF(275.0, 300.0);
    m_sizeRect1Rect2 = QSizeF(50.0, 250.0);
    m_pPhysValRect1Rect2->setSize(m_sizeRect1Rect2);
    m_pPhysValRect1Rect2->setCenter(QPointF(275.0, bYAxisTopDown ? 300.0 : fYAxisMaxVal - 300.0));
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameGroupRect1Rect2, m_ptPosRect1Rect2, *m_pPhysValRect1Rect2, false, iResultValuesPrecision));
    // Rect-1
    m_ptPosRect1 = QPointF(0.0, -100.0);
    m_rectRect1 = QRectF(QPointF(-25.0, -25.0), QSizeF(50.0, 50.0));
    m_pPhysValRect1->setCenter(QPointF(25.0, bYAxisTopDown ? 25.0 : 225.0));
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameRect1, m_ptPosRect1, m_rectRect1, *m_pPhysValRect1, false, iResultValuesPrecision));
    // Rect-2
    m_ptPosRect2 = QPointF(0.0, 100.0);
    m_rectRect2 = QRectF(QPointF(-25.0, -25.0), QSizeF(50.0, 50.0));
    m_pPhysValRect2->setCenter(QPointF(25.0, bYAxisTopDown ? 225.0 : 25.0));
    strlstExpectedValues.append(resultValuesForRect(
        c_strGraphObjNameRect2, m_ptPosRect2, m_rectRect2, *m_pPhysValRect2, false, iResultValuesPrecision));
    // ConnectionLine
    strGraphObjCnctPt1Name = "CnctPoint-" + CEnumSelectionPoint(ESelectionPoint::BottomCenter).toString() + "-1";
    ...
    pTestStep = new ZS::Test::CTestStep(
        /* pTest           */ this,
        /* strName         */ "Step " + QString::number(ZS::Test::CTestStep::testStepCount()) + " " + c_strGraphObjNameGroupRect1Rect2 + ".showLabel(" + CGraphObj::c_strLabelName + ")",
        /* strOperation    */ c_strGraphObjNameGroupRect1Rect2 + ".showLabel(" + CGraphObj::c_strLabelName + ")",
        /* pGrpParent      */ pGrpGroupsConnectionPointsAddGroups,
        /* szDoTestStepFct */ SLOT(doTestStepShowLabels(ZS::Test::CTestStep*)) );
    pTestStep->addDataRow({
        {"GraphObjName", c_strGraphObjNameGroupRect1Rect2},
        {"GraphObjKeyInTree", m_hshGraphObjNameToKeys[c_strGraphObjNameGroupRect1Rect2]},
        {"LabelName", CGraphObj::c_strLabelName},
        {"AnchorPoint", SGraphObjSelectionPoint(nullptr, ESelectionPointType::BoundingRectangle, ESelectionPoint::TopCenter).toString()},
        {"setPos", QPointF(220.0, 300.0)},
        {"ExpectedText", c_strGraphObjNameGroupRect1Rect2}
    });
}
...
//------------------------------------------------------------------------------
{
    ...
    strlstExpectedValues.append(resultValuesForGroup(
        c_strGraphObjNameSmallRect, m_ptPosSmallRect, *m_pPhysValRectSmallRect, false));
    // SmallRect-TopLine
