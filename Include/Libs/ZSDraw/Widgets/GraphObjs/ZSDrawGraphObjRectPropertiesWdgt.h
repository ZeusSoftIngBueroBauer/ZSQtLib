...
#ifndef ZSDraw_DrawGraphObjRectPropertiesWdgt_h
#define ZSDraw_DrawGraphObjRectPropertiesWdgt_h
...
//******************************************************************************
class ZSDRAWDLL_API CWdgtGraphObjRectProperties : public CWdgtGraphObjPropertiesAbstract
//******************************************************************************
{
    Q_OBJECT
public: // class methods
    static QString NameSpace() { return "ZS::Draw"; }
    static QString ClassName() { return "CWdgtGraphObjRectProperties"; }
    enum class EWidget {
        Labels,
        Geometry,
        LineStyle,
...
public: // ctors and dtor
    CWdgtGraphObjRectProperties(
        CDrawingScene* i_pDrawingScene,
        const QString& i_strObjName,
        bool i_bAddApplyResetButtons,
        QWidget* i_pWdgtParent = nullptr);
    virtual ~CWdgtGraphObjRectProperties();
...
protected: // instance members
    ...
    CWdgtGraphObjRectGeometryProperties* m_pWdgtGeometry;
    CWdgtGraphObjLineStyleProperties* m_pWdgtLineStyle;
    CWdgtGraphObjFillStyleProperties* m_pWdgtFillStyle;

}; // class CWdgtGraphObjRectProperties

} // namespace Draw

} // namespace ZS

#endif // #ifndef ZSDraw_DrawGraphObjRectPropertiesWdgt_h
