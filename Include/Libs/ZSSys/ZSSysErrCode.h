...
//==============================================================================
    ...
    EResultValuesNotEqual                    = 126, /*!< The compared values are not equal. */
    EResultNotConvertible                    = 127, /*!< The value could not be converted. */
    EResultInvalidSIUnit                     = 128, /*!< The SI base unit is invalid. */
    EResultPhysSizeNotChangeable             = 129, /*!< The physical size cannot be changed. */
    EResultRefValMissing                     = 130, /*!< The reference value is missing. */
    EResultInvalidRefValUnit                 = 131, /*!< The reference value has an invalid unit. */
    EResultLogarithmicUnitExpected           = 132, /*!< A logarithmic unit was not expected. */
    EResultDimensionOutOfRange               = 133, /*!< The dimension is outside the valid range. */
    EResultValIdxOutOfRange                  = 134, /*!< The value has an invalid index. */
    EResultValueOutOfRange                   = 135, /*!< The value is outside the valid range. */
    EResultValueExceedsMinLimit              = 136, /*!< The value falls below the permissible minimum. */
    EResultValueExceedsMaxLimit              = 137, /*!< The value exceeds the permissible maximum. */
    EResultNoValueAssigned                   = 138, /*!< No value has been assigned. */
    EResultNullValueNotAllowed               = 139, /*!< A (zero) value is not allowed. */
    EResultValueCorrected                    = 140, /*!< The value has been corrected. */
    EResultInvalidDataType                   = 141, /*!< The data type is not valid. */
    EResultUnknownDataType                   = 142, /*!< The data type is not known. */
    EResultUnsupportedDataType               = 143, /*!< The data type is not supported. */
    EResultPrimaryKeyConstraintViolation     = 144, /*!< The primary key is not valid. */
    EResultUniqueConstraintViolation         = 145, /*!< The key is not clear. */
    EResultForeignKeyConstraintViolation     = 146, /*!< The key to accessing another resource is not valid. */
    EResultStatementError                    = 147, /*!< Errors within a statement. */
    EResultTransactionError                  = 148, /*!< Error within a transfer. */
