...
{
    /*  0 */ SEnumEntry( EDrawAttributePenColor,                     XmlStreamParser::c_strXmlElemNamePenColor                     ),
    /*  1 */ SEnumEntry( EDrawAttributePenWidth,                     XmlStreamParser::c_strXmlElemNamePenWidth                     ),
    /*  2 */ SEnumEntry( EDrawAttributeFillColor,                    XmlStreamParser::c_strXmlElemNameFillColor                    ),
    /*  3 */ SEnumEntry( EDrawAttributeFillStyle,                    XmlStreamParser::c_strXmlElemNameFillStyle                    ),
    /*  4 */ SEnumEntry( EDrawAttributeLineStyle,                    XmlStreamParser::c_strXmlElemNameLineStyle                    ),
    /*  5 */ SEnumEntry( EDrawAttributeLineRecordType,               XmlStreamParser::c_strXmlElemNameLineRecordType               ),
    /*  6 */ SEnumEntry( EDrawAttributeLineExtent,                   XmlStreamParser::c_strXmlElemNameLineExtent                   ),
    /*  7 */ SEnumEntry( EDrawAttributeLineP1EndStyle,               XmlStreamParser::c_strXmlElemNameLineP1EndStyle               ),
    /* 13 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadBaseLineType,  XmlStreamParser::c_strXmlElemNameLineP1ArrowHeadBaseLineType  ),
    /* 14 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadFillStyle,     XmlStreamParser::c_strXmlElemNameLineP1ArrowHeadFillStyle     ),
    /* 15 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadWidth,         XmlStreamParser::c_strXmlElemNameLineP1ArrowHeadWidth         ),
    /* 16 */ SEnumEntry( EDrawAttributeLineP1ArrowHeadLength,        XmlStreamParser::c_strXmlElemNameLineP1ArrowHeadLength        ),
    /* 12 */ SEnumEntry( EDrawAttributeLineP2EndStyle,               XmlStreamParser::c_strXmlElemNameLineP2EndStyle               ),
    /* 13 */ SEnumEntry( EDrawAttributeLineP2ArrowHeadBaseLineType,  XmlStreamParser::c_strXmlElemNameLineP2ArrowHeadBaseLineType  ),
    /* 14 */ SEnumEntry( EDrawAttributeLineP2ArrowHeadFillStyle,     XmlStreamParser::c_strXmlElemNameLineP2ArrowHeadFillStyle     ),
