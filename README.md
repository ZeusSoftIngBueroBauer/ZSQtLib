...
- ./Build/<CompilerName>_<Platform>_<BuildType>
...
will be created in directory `./Lib/<CompilerName>_<Platform>` and the runtime binaries will be created
in directory `./Bin/<CompilerName>_<Platform>`.**
...
When building the ZSQtLib you should choose the sub directory `.\Build\<CompilerId>_<Platform>_<BuildType>`
...
the build directory should become
    ...
    /Projects/ZeusSoft/ZSQtLib/Build/<CompilerId>_<Platform>_<BuildType>

The relative path to the build directory is

    ./Build/<CompilerId>_<Platform>_<BuildType>
...
the <CompilerName>_<Platform> subdirectories.**
...
solution `ZSQtLib.sln` located in `.\Build\msvc2019_x64_<Debug|Release>`.
