...
/*******************************************************************************
class CTSGrpShutdownDbClt2 : public ZS::Test::CTestStepGroup
*******************************************************************************/
...
//------------------------------------------------------------------------------
CTSGrpShutdownDbClt2::CTSGrpShutdownDbClt2( CTest* i_pTest, ZS::Test::CTestStepGroup* i_pTSGrpParent ) :
//------------------------------------------------------------------------------
    ZS::Test::CTestStepGroup(i_pTest, "DbClt2", i_pTSGrpParent)
{
    ...
    //    /* pTSGrpParent    */ this,
    //    /* szDoTestStepFct */ SLOT(doTestStepGrpShutdownDbClt2Unregister(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpShutdownDbClt2Disconnect(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpShutdownDbClt2ShutdownClient(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpShutdownDbClt2DestroyDataSet(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpShutdownDbClt2DestroyClient(ZS::Test::CTestStep*)) );

} // ctor

//------------------------------------------------------------------------------
CTSGrpShutdownDbClt2::~CTSGrpShutdownDbClt2()
//------------------------------------------------------------------------------
{
} // dtor
...
//------------------------------------------------------------------------------
void CTest::doTestStepGrpShutdownDbClt2Unregister( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    ...
    CMethodTracer mthTracer(
        ...
        /* strMethod    */ "doTestStepGrpShutdownDbClt2Unregister",
...
} // doTestStepGrpShutdownDbClt2Unregister

//------------------------------------------------------------------------------
void CTest::doTestStepGrpShutdownDbClt2Disconnect( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpShutdownDbClt2Disconnect",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    strlstDesiredValues.append(strDesiredValue);
    strDesiredValue = m_pDbClt2->objectName() + " in DbCnctList: false";
    strlstDesiredValues.append(strDesiredValue);
    ...
    if( m_pDbClt2 != nullptr )
    {
        try
        {
            ...
            if( !QObject::connect(
                ...
                /* pObjReceiver */ this,
                /* szSlot       */ SLOT(onTestStepGrpShutdownDbClt2RequestChanged(ZS::System::SRequestDscr)) ) )
            {
...
} // doTestStepGrpShutdownDbClt2Disconnect

//------------------------------------------------------------------------------
void CTest::doTestStepGrpShutdownDbClt2ShutdownClient( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpShutdownDbClt2ShutdownClient",
        /* strAddInfo   */ strAddTrcInfo );
...
} // doTestStepGrpShutdownDbClt2ShutdownClient

//------------------------------------------------------------------------------
void CTest::doTestStepGrpShutdownDbClt2DestroyDataSet( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpShutdownDbClt2DestroyDataSet",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    try
    {
        emit dbClt2DataSetAboutToBeDestroyed(m_pDSDbClt2);
    ...
    strActualValue = "DS:" + QString(m_pDbClt2->getDataSet() == nullptr ? "nullptr" : m_pDbClt2->getDataSet()->getDSObjKey() );
    strlstActualValues.append(strActualValue);

    i_pTestStep->setActualValues(strlstActualValues);

} // doTestStepGrpShutdownDbClt2DestroyDataSet

//------------------------------------------------------------------------------
void CTest::doTestStepGrpShutdownDbClt2DestroyClient( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpShutdownDbClt2DestroyClient",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    try
    {
        emit dbClt2AboutToBeDestroyed(m_pDbClt2);
...
} // doTestStepGrpShutdownDbClt2DestroyClient
...
//------------------------------------------------------------------------------
void CTest::onTestStepGrpShutdownDbClt2RequestChanged( ZS::System::SRequestDscr i_reqDscr )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "onTestStepGrpShutdownDbClt2RequestChanged",
        /* strAddInfo   */ strAddTrcInfo );
        ...
        if( i_reqDscr.m_errResultInfo.isErrorResult() || i_reqDscr.m_iProgress_perCent >= 100 )
        {
            ...
            if( pTestStep != nullptr )
            {
                ...
                if( pTestStep->getName() == "Disconnect" )
                {
                    ...
                    QTimer::singleShot(m_iTestStepTimeoutSlotInterval_ms, this, SLOT(onTestStepGrpShutdownDbClt2Timeout()));
...
} // onTestStepGrpShutdownDbClt2RequestChanged

//------------------------------------------------------------------------------
void CTest::onTestStepGrpShutdownDbClt2Timeout()
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "onTestStepGrpShutdownDbClt2Timeout",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    if( m_pTestStepCurr != nullptr )
    {
        if( m_pTestStepCurr->getName() == "Disconnect" )
        {
            ...
            {
                if( arCltCnctDscrs[idxCnct].m_socketType == m_socketDscrDbClt2Tmp.m_socketType )
                {
...
} // onTestStepGrpShutdownDbClt2Timeout
