...
#ifndef ZSDraw_ObjFactoryText_h
#define ZSDraw_ObjFactoryText_h
...
{
//******************************************************************************
class ZSDRAWDLL_API CObjFactoryText : public CObjFactory
//******************************************************************************
{
public: // class methods
    ...
    static QString ClassName() { return "CObjFactoryText"; } // Please note that the static class functions name must be different from the non static virtual member function "className"
public: // ctors and dtor
    CObjFactoryText( const QPixmap& i_pxmToolIcon = QPixmap() );
    virtual ~CObjFactoryText();
public: // overridables
...
#endif // #ifndef ZSDraw_ObjFactoryText_h
