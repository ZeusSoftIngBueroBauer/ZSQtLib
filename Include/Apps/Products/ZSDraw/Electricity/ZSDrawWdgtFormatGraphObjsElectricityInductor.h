...
#ifndef ZSDraw_WdgtFormatGraphObjsElectricityInductor_h
#define ZSDraw_WdgtFormatGraphObjsElectricityInductor_h
...
public: // class methods
    ...
    /*! Returns the class name.
        Please note that the static class functions name must be different
        from the non static virtual member function "nameSpace" */
    static QString ClassName() { return "CWdgtFormatGraphObjsInductor"; }
public: // ctors and dtor
    CWdgtFormatGraphObjsInductor(
        CDrawingScene* i_pDrawingScene,
        CGraphObj*     i_pGraphObj,
        QWidget*       i_pWdgtParent = nullptr );
    virtual ~CWdgtFormatGraphObjsInductor();
...
private: // instance members
    ...
    QHBoxLayout*             m_pLytInductance;
    QLabel*                  m_pLblInductance;
...
#endif // #ifndef ZSDraw_WdgtFormatGraphObjsElectricityInductor_h
