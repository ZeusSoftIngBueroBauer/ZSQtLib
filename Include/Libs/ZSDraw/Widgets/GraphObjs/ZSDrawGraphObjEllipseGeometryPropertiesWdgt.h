...
#ifndef ZSDraw_DrawGraphObjEllipseGeometryPropertiesWdgt_h
#define ZSDraw_DrawGraphObjEllipseGeometryPropertiesWdgt_h
...
namespace Draw
{
class CModelGraphObjEllipseGeometry;

//******************************************************************************
class ZSDRAWDLL_API CWdgtGraphObjEllipseGeometryProperties : public CWdgtGraphObjPropertiesAbstract
//******************************************************************************
{
    Q_OBJECT
public: // class methods
    ...
    static QString ClassName() { return "CWdgtGraphObjEllipseGeometryProperties"; }
public: // ctors and dtor
    CWdgtGraphObjEllipseGeometryProperties(
        CDrawingScene* i_pDrawingScene,
        const QString& i_strNameSpace,
        const QString& i_strObjName,
        QWidget* i_pWdgtParent = nullptr);
    virtual ~CWdgtGraphObjEllipseGeometryProperties();
...
private: // instance members
    ...
    CModelGraphObjEllipseGeometry* m_pModelGeometry;
...
#endif // #ifndef ZSDraw_DrawGraphObjEllipseGeometryPropertiesWdgt_h
