...
#include "ZSDraw/Widgets/GraphObjs/ZSDrawGraphObjRectGeometryPropertiesWdgt.h"
...
/*******************************************************************************
class CWdgtGraphObjRectGeometryProperties : public CWdgtGraphObjPropertiesAbstract
*******************************************************************************/
...
//------------------------------------------------------------------------------
CWdgtGraphObjRectGeometryProperties::CWdgtGraphObjRectGeometryProperties(
    ...
    m_pModelGeometry(nullptr)
{
    ...
    QObject::connect(
        ...
        this, &CWdgtGraphObjRectGeometryProperties::onBtnCollapseClicked);
    ...
    QObject::connect(
        ...
        this, &CWdgtGraphObjRectGeometryProperties::onBtnResizeRowsAndColumnsToContentsClicked );
    ...
    m_pModelGeometry = new CModelGraphObjRectGeometry(
    ...
    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjRectGeometry::EColumnXVal, m_pEdtPhysValDelegateXVal);
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjRectGeometry::EColumnXVal, CTableView::SEditTriggerKey(Qt::Key_Return));

    m_pEdtPhysValDelegateYVal =
        new CEditPhysValtemDelegate(m_pModelGeometry, m_pTableViewGeometry);
    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjRectGeometry::EColumnYVal, m_pEdtPhysValDelegateYVal);
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjRectGeometry::EColumnYVal, CTableView::SEditTriggerKey(Qt::Key_Return));

    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjRectGeometry::EColumnShowVals,
        new CCheckBoxItemDelegate(m_pModelGeometry, m_pTableViewGeometry));
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjRectGeometry::EColumnShowVals, CTableView::SEditTriggerKey(Qt::Key_Return));

    m_pTableViewGeometry->setItemDelegateForColumn(
        CModelGraphObjRectGeometry::EColumnShowLine,
        new CCheckBoxItemDelegate(m_pModelGeometry, m_pTableViewGeometry));
    m_pTableViewGeometry->addKeyAsEditTriggerForColumn(
        CModelGraphObjRectGeometry::EColumnShowLine, CTableView::SEditTriggerKey(Qt::Key_Return));
    ...
    QObject::connect(
        m_pModelGeometry, &CModelGraphObjRectGeometry::contentChanged,
        this, &CWdgtGraphObjRectGeometryProperties::onModelGeometryContentChanged);
...
//------------------------------------------------------------------------------
void CWdgtGraphObjRectGeometryProperties::expand(bool i_bExpand)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
bool CWdgtGraphObjRectGeometryProperties::setKeyInTree(const QString& i_strKeyInTree)
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
    if (areMethodCallsActive(m_pTrcAdminObj, EMethodTraceDetailLevel::ArgsNormal)) {
...
//------------------------------------------------------------------------------
bool CWdgtGraphObjRectGeometryProperties::hasErrors() const
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
bool CWdgtGraphObjRectGeometryProperties::hasChanges() const
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjRectGeometryProperties::acceptChanges()
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjRectGeometryProperties::rejectChanges()
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjRectGeometryProperties::onBtnCollapseClicked(bool /*i_bChecked*/)
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjRectGeometryProperties::onBtnResizeRowsAndColumnsToContentsClicked(bool /*i_bChecked*/)
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
...
//------------------------------------------------------------------------------
void CWdgtGraphObjRectGeometryProperties::onModelGeometryContentChanged()
//------------------------------------------------------------------------------
{
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
