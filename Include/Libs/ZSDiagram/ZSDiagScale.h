...
public: // instance methods
    ...
    double getDivLineVal( const CEnumDivLineLayer& i_eLayer, int i_idxDivLine, PhysVal::CUnit* i_pUnit = nullptr ) const;
    double getDivLinePix( const CEnumDivLineLayer& i_eLayer, int i_idxDivLine ) const;
...
protected:  // instance members
    ...
    double m_fPixRes;
    QVector<int> m_ariDivLineDistMinPix; //[EDivLineLayerCount];
    QVector<int> m_ariDivLineCount; //[EDivLineLayerCount];
    QVector<QVector<double>> m_ararfDivLineVal; //[EDivLineLayerCount];
    QVector<QVector<double>> m_ararfDivLinePix; //[EDivLineLayerCount];
