...
#ifndef ZSRemCmdGUI_DllMain_h
#define ZSRemCmdGUI_DllMain_h
...
#ifdef ZSREMCMDGUIDLL_EXPORTS
    #define ZSREMCMDGUIDLL_API __API_EXPORT
#else
    #define ZSREMCMDGUIDLL_API __API_IMPORT
#endif
...
#endif // #ifndef ZSRemCmdGUI_DllMain_h
