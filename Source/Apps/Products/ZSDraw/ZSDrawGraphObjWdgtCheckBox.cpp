...
//------------------------------------------------------------------------------
void CGraphObjWdgtCheckBox::ResetCtorsDtorsCounters()
//------------------------------------------------------------------------------
{
...
qint64 CGraphObjWdgtCheckBox::s_iCtorsCount = 1;
qint64 CGraphObjWdgtCheckBox::s_iDtorsCount = 1;

CTrcAdminObj* CGraphObjWdgtCheckBox::s_pTrcAdminObjCtorsAndDtor = nullptr;
...
//------------------------------------------------------------------------------
    CGraphObjWdgt(
        ...
        /* strClassName  */ "CGraphObjWdgtCheckBox",
        /* strType       */ "CheckBox",
        /* strObjName    */ i_strObjName.isEmpty() ? "CheckBox" + QString::number(s_iCtorsCount) : i_strObjName,
        /* strObjId      */ i_strObjId.isEmpty() ? "CheckBox" + QString::number(s_iCtorsCount) : i_strObjId,
    ...
    m_pCheckBox(nullptr)
{
    ...
    {
        s_pTrcAdminObjCtorsAndDtor = CTrcServer::GetTraceAdminObj("ZS::Draw::QtWidgets", "CGraphObjWdgtCheckBox::CtorsAndDtor", "");
    }
...
//------------------------------------------------------------------------------
CGraphObj* CGraphObjWdgtCheckBox::clone()
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
