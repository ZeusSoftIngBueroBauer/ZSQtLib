...
#include "ZSDraw/GraphObjFormat/ZSDrawWdgtFormatGraphObjsFillStyle.h"
#include "ZSDraw/GraphObjFormat/ZSDrawWdgtFormatGraphObjsGeometry.h"
#include "ZSDraw/GraphObjFormat/ZSDrawWdgtFormatGraphObjsLabelVisibilities.h"
#include "ZSDraw/GraphObjFormat/ZSDrawWdgtFormatGraphObjsLineStyle.h"
#include "ZSDraw/GraphObjFormat/ZSDrawWdgtFormatGraphObjsText.h"
#include "ZSDraw/GraphObjFormat/ZSDrawWdgtFormatGraphObjsTextStyle.h"
    ...
    m_pTrcAdminObj(nullptr)
{
    ...
    if (areMethodCallsActive(m_pTrcAdminObj, EMethodTraceDetailLevel::ArgsNormal)) {
        strMthInArgs = "DrawingScene: " + QString(i_pDrawingScene == nullptr ? "null" : i_pDrawingScene->objectName())
                     + ", GraphObj: " + QString(i_pGraphObj == nullptr ? "null" : i_pGraphObj->typeAsString() + ":" + i_pGraphObj->objectName());
    }
