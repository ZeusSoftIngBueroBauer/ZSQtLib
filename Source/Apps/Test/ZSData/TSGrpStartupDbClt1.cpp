...
/*******************************************************************************
class CTSGrpStartupDbClt1 : public ZS::Test::CTestStepGroup
*******************************************************************************/
...
//------------------------------------------------------------------------------
CTSGrpStartupDbClt1::CTSGrpStartupDbClt1( CTest* i_pTest, ZS::Test::CTestStepGroup* i_pTSGrpParent ) :
//------------------------------------------------------------------------------
    ZS::Test::CTestStepGroup(i_pTest, "DbClt1", i_pTSGrpParent)
{
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpStartupDbClt1CreateClient(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpStartupDbClt1CreateDataSet(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpStartupDbClt1InitSettings(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpStartupDbClt1StartupClient(ZS::Test::CTestStep*)) );
    ...
    new ZS::Test::CTestStep(
        ...
        /* pTSGrpParent    */ this,
        /* szDoTestStepFct */ SLOT(doTestStepGrpStartupDbClt1Connect(ZS::Test::CTestStep*)) );
    ...
    //    /* pTSGrpParent    */ this,
    //    /* szDoTestStepFct */ SLOT(doTestStepGrpStartupDbClt1Register(ZS::Test::CTestStep*)) );
    ...
    //    /* pTSGrpParent    */ this,
    //    /* szDoTestStepFct */ SLOT(doTestStepGrpStartupDbClt1SelectSchema(ZS::Test::CTestStep*)) );

} // ctor

//------------------------------------------------------------------------------
CTSGrpStartupDbClt1::~CTSGrpStartupDbClt1()
//------------------------------------------------------------------------------
{
} // dtor
...
//------------------------------------------------------------------------------
void CTest::doTestStepGrpStartupDbClt1CreateClient( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    ...
    CMethodTracer mthTracer(
        ...
        /* strMethod    */ "doTestStepGrpStartupDbClt1CreateClient",
    ...
    m_pDbClt1 = new CDbClient(c_strObjNameDbClt1); 

    //m_pDbClt1->setReqTimeout(m_iReqTimeout_ms);
    m_pDbClt1->setKeepReqDscrInExecTree(m_bKeepReqDscrInExecTree);

    emit dbClt1Created(m_pDbClt1);

    // Actual Values
    //---------------

    QList<EProtocolType> arProtTypes = m_pDbClt1->getProtocolTypes();

    for( idxProtType = 0; idxProtType < arProtTypes.size(); idxProtType++ )
    {
        protType = arProtTypes[idxProtType];

        QList<ESocketType> arSockTypes = m_pDbClt1->getSocketTypes(protType);
        ...
        for( idxSockType = 0; idxSockType < arSockTypes.size(); idxSockType++ )
        {
            ...
            strActualValue += m_pDbClt1->getConnectionString(protType, sockType);
...
} // doTestStepGrpStartupDbClt1CreateClient

//------------------------------------------------------------------------------
void CTest::doTestStepGrpStartupDbClt1CreateDataSet( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpStartupDbClt1CreateDataSet",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    strDesiredValue = "DS:" + c_strObjNameDbClt1DS;
    strlstDesiredValues.append(strDesiredValue);
    ...
    if( m_pDbClt1 != nullptr )
    {
        try
        {
            m_pDSDbClt1 = new CDataSet(c_strObjNameDbClt1DS);
            m_pDbClt1->setDataSet(m_pDSDbClt1);

            emit dbClt1DataSetCreated(m_pDSDbClt1);
        }
    ...
    strActualValue = QString(m_pDSDbClt1 == nullptr ? "nullptr" : m_pDSDbClt1->getDSObjKey() );
    strlstActualValues.append(strActualValue);

    i_pTestStep->setActualValues(strlstActualValues);

} // doTestStepGrpStartupDbClt1CreateDataSet

//------------------------------------------------------------------------------
void CTest::doTestStepGrpStartupDbClt1InitSettings( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpStartupDbClt1InitSettings",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    cnctType.m_protocolType = EProtocolTypeZSMsg;
    cnctType.m_socketType = ESocketTypeInProcMsg;
    ...
    if( m_pDbClt1 != nullptr )
    {
        try
        {
            m_pDbClt1->setDefaultProtocolType(protType);
            m_pDbClt1->setDefaultSocketType(sockType);
            ...
            for( idxProtType = 0; idxProtType < m_arProtocolTypes.size(); idxProtType++ )
            {
                ...
                for( idxSockType = 0; idxSockType < m_hsharSocketTypes[cnctType.m_protocolType].size(); idxSockType++ )
                {
                    ...
                    m_pDbClt1->setDefaultHostSettings(cltHostSettingsDefault, protType);
                    m_pDbClt1->setDefaultWatchDogSettings(watchDogSettingsDefault, protType, sockType);
            ...
            m_pDbClt1->setProtocolType(cnctType.m_protocolType);
            m_pDbClt1->setSocketType(cnctType.m_socketType);
            ...
            m_pDbClt1->setHostSettings(cltHostSettings);
            m_pDbClt1->setWatchDogSettings(watchDogSettings);

            pReq = m_pDbClt1->updateHostSettings(
                /* iTimeout_ms  */ m_iReqTimeout_ms,
                /* bWait        */ false,
                /* iReqIdParent */ -1 );
        }
    ...
    if( m_pDbClt1 != nullptr )
    {
        ...
        strActualValue += m_pDbClt1->getConnectionString();
        strlstActualValues.append(strActualValue);

        strActualValue = "- WatchDog: " + m_pDbClt1->getWatchDogSettings().toString();
        strlstActualValues.append(strActualValue);
        ...
        for( idxProtType = 0; idxProtType < m_arProtocolTypes.size(); idxProtType++ )
        {
            ...
            for( idxSockType = 0; idxSockType < m_hsharSocketTypes[cnctType.m_protocolType].size(); idxSockType++ )
            {
                ...
                strActualValue = " - Host: " + m_pDbClt1->getDefaultConnectionString(protType, sockType);
                strlstActualValues.append(strActualValue);

                watchDogSettingsDefault = m_hshWatchDogSettingsDefault[cnctType];
                strActualValue = " - WatchDog: " + m_pDbClt1->getDefaultWatchDogSettings(protType,sockType)->toString();
                strlstActualValues.append(strActualValue);
...
} // doTestStepGrpStartupDbClt1InitSettings

//------------------------------------------------------------------------------
void CTest::doTestStepGrpStartupDbClt1StartupClient( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpStartupDbClt1StartupClient",
        /* strAddInfo   */ strAddTrcInfo );
...
} // doTestStepGrpStartupDbClt1StartupClient

//------------------------------------------------------------------------------
void CTest::doTestStepGrpStartupDbClt1Connect( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpStartupDbClt1Connect",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    strlstDesiredValues.append(strDesiredValue);
    strDesiredValue = m_pDbClt1->objectName() + " in DbCnctList: true";
    strlstDesiredValues.append(strDesiredValue);
    ...
    if( m_pDbClt1 != nullptr )
    {
        try
        {
            ...
            if( !QObject::connect(
                ...
                /* pObjReceiver */ this,
                /* szSlot       */ SLOT(onTestStepGrpStartupDbClt1RequestChanged(ZS::System::SRequestDscr)) ) )
            {
...
} // doTestStepGrpStartupDbClt1Connect

//------------------------------------------------------------------------------
void CTest::doTestStepGrpStartupDbClt1Register( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpStartupDbClt1Register",
        /* strAddInfo   */ strAddTrcInfo );
...
} // doTestStepGrpStartupDbClt1Register

//------------------------------------------------------------------------------
void CTest::doTestStepGrpStartupDbClt1SelectSchema( ZS::Test::CTestStep* i_pTestStep )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "doTestStepGrpStartupDbClt1SelectSchema",
        /* strAddInfo   */ strAddTrcInfo );
...
} // doTestStepGrpStartupDbClt1SelectSchema
...
//------------------------------------------------------------------------------
void CTest::onTestStepGrpStartupDbClt1RequestChanged( ZS::System::SRequestDscr i_reqDscr )
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "onTestStepGrpStartupDbClt1RequestChanged",
        /* strAddInfo   */ strAddTrcInfo );
        ...
        if( i_reqDscr.m_errResultInfo.isErrorResult() || i_reqDscr.m_iProgress_perCent >= 100 )
        {
            ...
            if( pTestStep != nullptr )
            {
                ...
                if( pTestStep->getName() == "Connect" )
                {
                    ...
                    QTimer::singleShot(m_iTestStepTimeoutSlotInterval_ms, this, SLOT(onTestStepGrpStartupDbClt1Timeout()));
...
} // onTestStepGrpStartupDbClt1RequestChanged

//------------------------------------------------------------------------------
void CTest::onTestStepGrpStartupDbClt1Timeout()
//------------------------------------------------------------------------------
{
    QString strAddTrcInfo;
    ...
    CMethodTracer mthTracer(
        /* pAdminObj    */ m_pTrcAdminObj,
        /* iDetailLevel */ ETraceDetailLevelMethodCalls,
        /* strMethod    */ "onTestStepGrpStartupDbClt1Timeout",
        /* strAddInfo   */ strAddTrcInfo );
    ...
    if( m_pTestStepCurr != nullptr )
    {
        if( m_pTestStepCurr->getName() == "Connect" )
        {
            ...
            m_socketDscrDbClt1Tmp = m_pDbClt1->getSocketDscr();
...
} // onTestStepGrpStartupDbClt1Timeout
