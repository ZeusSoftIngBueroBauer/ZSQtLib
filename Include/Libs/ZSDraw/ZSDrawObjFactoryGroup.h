...
#ifndef ZSDraw_ObjFactoryGroup_h
#define ZSDraw_ObjFactoryGroup_h
...
{
//******************************************************************************
class ZSDRAWDLL_API CObjFactoryGroup : public CObjFactory
//******************************************************************************
{
public: // class methods
    ...
    static QString ClassName() { return "CObjFactoryGroup"; }  // Please note that the static class functions name must be different from the non static virtual member function "className"
public: // ctors and dtor
    CObjFactoryGroup( const QPixmap& i_pxmToolIcon = QPixmap() );
    virtual ~CObjFactoryGroup();
public: // overridables
...
#endif // #ifndef ZSDraw_ObjFactoryGroup_h
