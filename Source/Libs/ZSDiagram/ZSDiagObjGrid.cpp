        ...
        if( isVisible() )
        {
            ...
            for( int iLayer = CEnumDivLineLayer::count()-1; iLayer >= 0; iLayer-- )
            {
                if( m_arbShow[iLayer] )
                {
                    ...
                    for( idxDivLine = 0; idxDivLine < m_arpDiagScale[EScaleDirX]->getDivLineCount(static_cast<EDivLineLayer>(iLayer)); idxDivLine++ )
                    {
                        xDivLine = static_cast<int>(m_arpDiagScale[EScaleDirX]->getDivLinePix(static_cast<EDivLineLayer>(iLayer), idxDivLine) + 0.5);
                    ...
                    for( idxDivLine = 0; idxDivLine < m_arpDiagScale[EScaleDirY]->getDivLineCount(static_cast<EDivLineLayer>(iLayer)); idxDivLine++ )
                    {
                        ...
                        yDivLine = static_cast<int>(m_arpDiagScale[EScaleDirY]->getDivLinePix(static_cast<EDivLineLayer>(iLayer), idxDivLine) + 0.5);
