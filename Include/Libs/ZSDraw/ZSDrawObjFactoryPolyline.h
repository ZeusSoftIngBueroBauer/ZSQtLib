...
public: // class methods
    ...
    static QString ClassName() { return "CObjFactoryPolyline"; } // Please note that the static class functions name must be different from the non static virtual member function "className"
public: // ctors and dtor
    CObjFactoryPolyline( const QIcon& i_toolIcon = QIcon() );
