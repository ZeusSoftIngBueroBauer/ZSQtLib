    ...
    m_pTrcAdminObj(nullptr)
{
    ...
    double  fXResolution_dpi = m_pDrawingView->getXResolutionInDpmm()*25.4;
    double  fYResolution_dpi = m_pDrawingView->getYResolutionInDpmm()*25.4;

    QString strXDpi  = QString::number(fXResolution_dpi,'f',2);
    QString strYDpi  = QString::number(fYResolution_dpi,'f',2);
    QString strXDpmm = QString::number(m_pDrawingView->getXResolutionInDpmm(),'f',2);
    QString strYDpmm = QString::number(m_pDrawingView->getYResolutionInDpmm(),'f',2);
...
//------------------------------------------------------------------------------
{
    ...
    m_pEdtSizeWidth->setText( QString::number(m_pageSetup.getDrawingWidthInPixels()) );

    // <EditField> Size - Height
    //-------------------------

    m_pEdtSizeHeight->setText( QString::number(m_pageSetup.getDrawingHeightInPixels()) );

    emit pageSetupAttributeChanged( EPageSetupAttributeDrawingWidthInPixels, m_pageSetup.getDrawingWidthInPixels() );
    emit pageSetupAttributeChanged( EPageSetupAttributeDrawingHeightInPixels, m_pageSetup.getDrawingHeightInPixels() );
...
//------------------------------------------------------------------------------
{
    ...
    m_pageSetup.setDrawingWidthInPixels(i_strText.toInt());
...
//------------------------------------------------------------------------------
{
    ...
    m_pageSetup.setDrawingHeightInPixels(i_strText.toInt());
