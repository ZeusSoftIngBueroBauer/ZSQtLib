...
//******************************************************************************
class ZSDRAWDLL_API CWdgtDrawingPaperPageSetup : public QWidget
//******************************************************************************
{
    Q_OBJECT
public: // class methods
    ...
    static QString ClassName() { return "CWdgtDrawingPaperPageSetup"; } // Please note that the static class functions name must be different from the non static virtual member function "className"
public: // instance methods
    CWdgtDrawingPaperPageSetup( CDrawingView* i_pDrawingView, QWidget* i_pWdgtParent = nullptr );
