...
#ifndef ZSDraw_ObjFactoryEllipse_h
#define ZSDraw_ObjFactoryEllipse_h
...
{
//******************************************************************************
class ZSDRAWDLL_API CObjFactoryEllipse : public CObjFactory
//******************************************************************************
{
public: // class methods
    ...
    static QString ClassName() { return "CObjFactoryEllipse"; }  // Please note that the static class functions name must be different from the non static virtual member function "className"
public: // ctors and dtor
    CObjFactoryEllipse( const QPixmap& i_pxmToolIcon = QPixmap() );
    virtual ~CObjFactoryEllipse();
public: // overridables
...
#endif // #ifndef ZSDraw_ObjFactoryEllipse_h
