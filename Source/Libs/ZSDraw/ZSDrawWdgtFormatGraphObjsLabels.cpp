    ...
    if( m_pCmbNameLabelAnchorSelPt != nullptr && m_pChkNameLabelVisible != nullptr && m_pChkNameLabelAnchorLineVisible != nullptr )
    {
        ...
        if( bConverted )
        {
            ...
            if( m_pChkNameLabelAnchorLineVisible->isChecked() )
            {
                ...
                {
                    m_pGraphObj->showNameLabelAnchorLine(eSelPt.enumerator());
                }
            }
            else
            {
    ...
    if( m_pCmbPathLabelAnchorSelPt != nullptr && m_pChkPathLabelVisible != nullptr && m_pChkPathLabelAnchorLineVisible != nullptr )
    {
        ...
        if( bConverted )
        {
            ...
            if( m_pChkPathLabelAnchorLineVisible->isChecked() )
            {
                ...
                {
                    m_pGraphObj->showPathLabelAnchorLine(eSelPt.enumerator());
                }
            }
            else
            {
...
//------------------------------------------------------------------------------
{
    ...
    if( !bHasChanges && m_pCmbNameLabelAnchorSelPt != nullptr && m_pChkNameLabelVisible != nullptr && m_pChkNameLabelAnchorLineVisible != nullptr )
    {
        ...
        if( !bHasChanges )
        {
            bHasChanges = (m_pGraphObj->isNameLabelAnchorLineVisible(eSelPt.enumerator()) != m_pChkNameLabelAnchorLineVisible->isChecked());
        }
    }
    if( !bHasChanges && m_pCmbPathLabelAnchorSelPt != nullptr && m_pChkPathLabelVisible != nullptr && m_pChkPathLabelAnchorLineVisible != nullptr )
    {
        ...
        if( !bHasChanges )
        {
            bHasChanges = (m_pGraphObj->isPathLabelAnchorLineVisible(eSelPt.enumerator()) != m_pChkPathLabelAnchorLineVisible->isChecked());
        }
    }
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onCmbNameLabelAnchorSelPtCurrentIndexChanged( int i_iIdx )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkNameLabelVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkNameLabelAnchorLineVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onCmbPathLabelAnchorSelPtCurrentIndexChanged( int i_iIdx )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkPathLabelVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkPathLabelAnchorLineVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onCmbDimensionPosLabelAnchorSelPtCurrentIndexChanged( int i_iIdx )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionPosLabelVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionPosLabelAnchorLineVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onCmbDimensionWidthLabelAnchorSelPtCurrentIndexChanged( int i_iIdx )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionWidthLabelVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionWidthLabelAnchorLineVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onCmbDimensionHeightLabelAnchorSelPtCurrentIndexChanged( int i_iIdx )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionHeightLabelVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionHeightLabelAnchorLineVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onCmbDimensionRotationAngleLabelAnchorSelPtCurrentIndexChanged( int i_iIdx )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionRotationAngleLabelVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionRotationAngleLabelAnchorLineVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionLinesBoundingRectVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionLinesBoundingRectDiagonalsVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionLinesBoundingRectHorizontalSymmetryAxisVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::onChkDimensionLinesBoundingRectVerticalSymmetryAxisVisibleStateChanged( int i_iCheckState )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::fillComboAnchorSelPt( QComboBox* i_pCmb )
//------------------------------------------------------------------------------
{
    QString strMthInArgs;
...
//------------------------------------------------------------------------------
void CWdgtFormatGraphObjsLabels::updateVisibilityCheckStates(
...
//------------------------------------------------------------------------------
{
    ...
    if( eSelPt == ESelectionPoint::All )
    {
        ...
        if( i_pCmbSelPt->objectName() == "Name" )
        {
            ...
            bAllLabelsAnchorLinesAreVisible = m_pGraphObj->isNameLabelAnchorLineVisible(ESelectionPoint::All);
            bAnyLabelsAnchorLineIsVisible = m_pGraphObj->isNameLabelAnchorLineVisible(ESelectionPoint::Any);
        }
        else if( i_pCmbSelPt->objectName() == "Path" )
        {
            ...
            bAllLabelsAnchorLinesAreVisible = m_pGraphObj->isPathLabelAnchorLineVisible(ESelectionPoint::All);
            bAnyLabelsAnchorLineIsVisible = m_pGraphObj->isPathLabelAnchorLineVisible(ESelectionPoint::Any);
        }
    ...
    else
    {
        ...
        {
            bIsLabelVisible = m_pGraphObj->isPathLabelVisible();
