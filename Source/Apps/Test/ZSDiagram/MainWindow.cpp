    ...
    m_pWdgtCentral(nullptr)
{
    ...
    {
        QString strActionSettingsFileInfo = "Settings File: " + CApplication::GetInstance()->getSettingsFile()->fileName();

        m_pActInfoSettingsFile = new QAction(strActionSettingsFileInfo,this);
