...
#ifndef ZSApps_TestRemCmdServer_TestModule1_h
#define ZSApps_TestRemCmdServer_TestModule1_h
...
protected slots:
    void onTestModule2Created( QObject* i_pThread, QObject* i_pTestModule2Thread );
protected slots:
    void onTestModule2ThreadDestroyed( QObject* i_pThread );
    void onTestModule2Destroyed( QObject* i_pTestModule );
...
#endif // #ifndef ZSApps_TestRemCmdServer_TestModule1_h
