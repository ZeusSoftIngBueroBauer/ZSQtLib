...
//------------------------------------------------------------------------------
    CImageStyle(),
    m_pxm(":/ZS/Diagram/SplitHCursorFocused"),
    m_bmpMask(":/ZS/Diagram/SplitHCursorFocusedMask")
{
    m_pxm.setMask(m_bmpMask);
...
//------------------------------------------------------------------------------
    CImageStyle(),
    m_pxm(":/ZS/Diagram/SplitHCursorEditing"),
    m_bmpMask(":/ZS/Diagram/SplitHCursorEditingMask")
{
    m_pxm.setMask(m_bmpMask);
...
//------------------------------------------------------------------------------
    CImageStyle(),
    m_pxm(":/ZS/Diagram/SplitVCursorFocused"),
    m_bmpMask(":/ZS/Diagram/SplitVCursorFocusedMask")
{
    m_pxm.setMask(m_bmpMask);
...
//------------------------------------------------------------------------------
    CImageStyle(),
    m_pxm(":/ZS/Diagram/SplitVCursorEditing"),
    m_bmpMask(":/ZS/Diagram/SplitVCursorEditingMask")
{
    m_pxm.setMask(m_bmpMask);
