...
DEP_DIR := $(ZSQTLIB_DIR_TMP)/Dep/$(MODULE)Binding4Python/$(PLATFORM)/$(CONFIG)
export DEP_DIR
...
INT_DIR := $(ZSQTLIB_DIR_TMP)/Int/$(MODULE)Binding4Python/$(PLATFORM)/$(CONFIG)
export INT_DIR
...
# will be written to.
MOC_DIR := $(ZSQTLIB_DIR_TMP)/Moc/$(MODULE)Binding4Python/$(PLATFORM)/$(CONFIG)
export MOC_DIR
...
OUT_DIR := $(ZSQTLIB_DIR_TMP)/Out/$(MODULE)Binding4Python/$(PLATFORM)/$(CONFIG)
export OUT_DIR
...
SBK_DIR := $(ZSQTLIB_DIR_TMP)/Shiboken/Python$(PYTHONVERSION)/$(PLATFORM)/$(CONFIG)/ZSQtLib/$(MODULE)
export SBK_DIR
